...
namespace ARGlasses.Interaction
{
    ...
    public class DebugGizmos : MonoBehaviour
    {
        ...
        private static readonly Color[] ColorCycle = { Color.red, Color.green, Color.blue, };
        public static void DrawLines(Transform t = null, params Vector3[] points)
        {
            for (int i = 0; i < points.Length - 1; i++)
            {
                Color = ColorCycle[i % ColorCycle.Length];
                DrawLine(points[i], points[i + 1], t);
            }
        }
        ...
        public static void Draw(Pose pose, float length = 0.2f)
        {
            DrawLine(pose.position, pose.position + pose.forward * length);
        }
        ...
        public readonly static IReadOnlyList<Vector3> CUBE_POINTS = new List<Vector3>()
        {
        ...
        public readonly static IReadOnlyList<int> CUBE_SEGMENTS = new List<int>()
        {
            0,
            1,
            1,
