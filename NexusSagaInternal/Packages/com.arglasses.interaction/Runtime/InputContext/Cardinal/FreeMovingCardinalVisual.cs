...
{
    public class FreeMovingCardinalVisual : MonoBehaviour
    {
        ...
        private Vector3 _lerpCursorPosition;
        private void UpdateVisual()
        {
            ...
            _lerpCursorPosition = Vector3.Lerp(_lerpCursorPosition, pos, Time.deltaTime * 12f);
            _cursorLayout.transform.SetPositionAndRotation(_lerpCursorPosition, rot);
        }
    }
}
