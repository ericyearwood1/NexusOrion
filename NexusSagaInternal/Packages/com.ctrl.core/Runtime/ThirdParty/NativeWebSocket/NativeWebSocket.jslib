...
var LibraryWebSocket = {
	 ...
	 */
	NativeWebSocketSetOnOpen: function(callback) {
	 ...
	 * @param callback Reference to C# static function
	 */
	NativeWebSocketSetOnMessage: function(callback) {
	 ...
	 * @param callback Reference to C# static function
	 */
	NativeWebSocketSetOnError: function(callback) {
	 ...
	 * @param callback Reference to C# static function
	 */
	NativeWebSocketSetOnClose: function(callback) {
	 ...
	 */
	NativeWebSocketAllocate: function(url) {
   ...
   */
  NativeWebSocketAddSubProtocol: function(instanceId, subprotocol) {
	 ...
	 * @param instanceId Instance ID
	 */
	NativeWebSocketFree: function(instanceId) {
	 ...
	 * @param instanceId Instance ID
	 */
	NativeWebSocketConnect: function(instanceId) {
	 ...
	 */
	NativeWebSocketClose: function(instanceId, code, reasonPtr) {
	 ...
	 */
	NativeWebSocketSend: function(instanceId, bufferPtr, length) {
	 ...
	 * @param length Length of the message in the buffer
	 */
	NativeWebSocketSendText: function(instanceId, message) {
	 ...
	 * @param instanceId Instance ID
	 */
	NativeWebSocketGetState: function(instanceId) {
