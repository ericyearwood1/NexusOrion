...
namespace Meta.XR.BuildingBlocks.Editor
{
    public abstract class BlockBaseData : ScriptableObject, ITaggable, IIdentified
    {
        ...
        {
#if OVR_INTERNAL_CODE // Internal Only Tag
            if(AssetDatabase.GetAssetPath(this).Contains("/OculusInternal/"))
            {
                Tags.Add(Utils.InternalTag);
            }
            else
#endif
            {
        ...
        public bool Internal => Tags.Contains(Utils.InternalTag);
        ...
        public bool InternalBlock => AssetDatabase.GetAssetPath(this).Contains("/OculusInternal/");
