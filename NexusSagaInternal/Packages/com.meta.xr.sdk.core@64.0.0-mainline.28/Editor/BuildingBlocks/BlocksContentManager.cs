...
namespace Meta.XR.BuildingBlocks.Editor
{
    ...
    internal static class BlocksContentManager
    {
        ...
        private const string EnableRemoteContentKey = "BlocksContentManager.EnableRemoteContentKey";

        internal static bool IsRemoteContentEnabled => EditorPrefs.GetBool(EnableRemoteContentKey, true);

        internal static void ToggleEnableRemoteContentState()
        {
            EditorPrefs.SetBool(EnableRemoteContentKey, !IsRemoteContentEnabled);
        }
