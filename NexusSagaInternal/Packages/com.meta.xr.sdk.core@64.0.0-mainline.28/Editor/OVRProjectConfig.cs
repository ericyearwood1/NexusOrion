...
public class OVRProjectConfig : ScriptableObject, ISerializationCallbackReceiver
{
    ...
    public FeatureSupport planeDetectionSupport = FeatureSupport.None;
#endif
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
    public FeatureSupport localGroupSupport = FeatureSupport.None;
#endif
...
#if OVR_INTERNAL_CODE
            projectConfig.planeDetectionSupport = FeatureSupport.None;
#endif
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
            projectConfig.localGroupSupport = FeatureSupport.None;
#endif
