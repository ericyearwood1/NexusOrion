...
#if OVR_INTERNAL_CODE
public readonly partial struct OVRRoomLabel : IOVRAnchorComponent<OVRRoomLabel>, IEquatable<OVRRoomLabel>
{
    SpaceComponentType IOVRAnchorComponent<OVRRoomLabel>.Type => Type;

    ulong IOVRAnchorComponent<OVRRoomLabel>.Handle => Handle;

    OVRRoomLabel IOVRAnchorComponent<OVRRoomLabel>.FromAnchor(OVRAnchor anchor) => new OVRRoomLabel(anchor);

    /// <summary>
    /// A null representation of an OVRRoomLabel.
    /// </summary>
    /// <remarks>
    /// Use this to compare with another component to determine whether it is null.
    /// </remarks>
    public static readonly OVRRoomLabel Null = default;
    ...
    OVRTask<bool> IOVRAnchorComponent<OVRRoomLabel>.SetEnabledAsync(bool enabled, double timeout)
        => throw new NotSupportedException("The RoomLabel component cannot be enabled or disabled.");
    ...
    /// <param name="other">The other component to compare with.</param>
    /// <returns>True if both components belong to the same <see cref="OVRAnchor" />, otherwise false.</returns>
    public bool Equals(OVRRoomLabel other) => Handle == other.Handle;
    ...
    /// <param name="rhs">The component to compare with <paramref name="lhs" />.</param>
    /// <returns>True if both components belong to the same <see cref="OVRAnchor" />, otherwise false.</returns>
    public static bool operator ==(OVRRoomLabel lhs, OVRRoomLabel rhs) => lhs.Equals(rhs);
    ...
    /// </summary>
    /// <param name="obj">The `object` to compare with.</param>
    /// <returns>True if <paramref name="obj" /> is an OVRRoomLabel and <see cref="Equals(OVRRoomLabel)" /> is true, otherwise false.</returns>
    public override bool Equals(object obj) => obj is OVRRoomLabel other && Equals(other);
    ...
    /// </summary>
    /// <returns>A string representation of this component.</returns>
    public override string ToString() => $"{Handle}.RoomLabel";

    internal SpaceComponentType Type => SpaceComponentType.RoomLabel;

    internal ulong Handle { get; }

    private OVRRoomLabel(OVRAnchor anchor) => Handle = anchor.Handle;
}
