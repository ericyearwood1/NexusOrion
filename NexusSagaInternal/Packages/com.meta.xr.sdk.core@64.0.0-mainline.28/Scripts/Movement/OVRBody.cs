    ...
    OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider
{
    ...
    public bool SuggestBodyTrackingCalibration(float height)
    {
        return OVRPlugin.SuggestBodyTrackingCalibrationOverride(new OVRPlugin.BodyTrackingCalibrationInfo{BodyHeight = height});
    }
