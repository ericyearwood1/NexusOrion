...
namespace Meta.XR.EnvironmentDepth
{
    ...
    public class EnvironmentDepthTextureProvider : MonoBehaviour
    {
        ...
        /// <summary>
        /// Enables/disables fetching of the environment depth texture.
        /// </summary>
        ...
        /// </summary>
        /// <param name="areHandsRemoved"></param>
        ...
        private void EnableEnvironmentDepth()
        {
        ...
        private void DisableEnvironmentDepth()
        {
            if (!EnvironmentDepthUtils.IsDepthRenderingRequestEnabled)
            {
                return;
