...
namespace Meta.XR.EnvironmentDepth
{
    ...
    public class EnvironmentDepthOcclusionController : MonoBehaviour
    {
        ...
        /// <param name="updateDepthTextureProvider"> If this is set to true,
        /// it disables the depthtextureprovider if newOcclusionType is set to NoOcclusions and enables it otherwise</param>
