...
public class OVROverlayEditor : Editor
{
...
#if OVR_INTERNAL_CODE
        _propOverrideBlendFactors = serializedObject.FindProperty(nameof(OVROverlay.overrideBlendFactors));
        _propSrcBlendFactor = serializedObject.FindProperty(nameof(OVROverlay.srcBlendFactor));
        _propDstBlendFactor = serializedObject.FindProperty(nameof(OVROverlay.dstBlendFactor));
#endif
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(_propOverrideBlendFactors, new GUIContent("Customize blend mode",
