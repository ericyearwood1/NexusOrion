...
#if OVR_INTERNAL_CODE
    [Obsolete("Please use " + nameof(AutoMapBones) +
              "(" + nameof(OVRCustomSkeleton.RetargetingType.OculusSkeleton) + ") instead")]
#endif // OVR_INTERNAL_CODE
