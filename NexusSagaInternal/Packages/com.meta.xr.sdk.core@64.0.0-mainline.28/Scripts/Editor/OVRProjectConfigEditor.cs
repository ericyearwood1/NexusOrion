    ...
    public static void DrawProjectConfigInspector(OVRProjectConfig projectConfig)
    {
        ...
        switch (selectedTab)
        {
            case eProjectConfigTab.General:
                ...
                OVREditorUtil.SetupEnumField(projectConfig, "Plane Detection Support",
                    ref projectConfig.planeDetectionSupport, ref hasModified);
            ...
            case eProjectConfigTab.Experimental:
                ...
                // Local Group Support
                OVREditorUtil.SetupEnumField(projectConfig, "Local Group Support",
                    ref projectConfig.localGroupSupport, ref hasModified);
