...
public class OVRPassthroughLayerEditor : Editor
{
    ...
    private SerializedProperty _propOverrideBlendFactors;
    private SerializedProperty _propSrcBlendFactor;
    private SerializedProperty _propDstBlendFactor;
#endif
...
#if OVR_INTERNAL_CODE
        _propOverrideBlendFactors = serializedObject.FindProperty(nameof(OVRPassthroughLayer.overrideBlendFactors));
        _propSrcBlendFactor = serializedObject.FindProperty(nameof(OVRPassthroughLayer.srcBlendFactor));
        _propDstBlendFactor = serializedObject.FindProperty(nameof(OVRPassthroughLayer.dstBlendFactor));
#endif
...
#if OVR_INTERNAL_CODE
        EditorGUILayout.PropertyField(_propOverrideBlendFactors,
            new GUIContent("Customize blend mode",
                "Explicitly specify the blend factors used to composite the overlay."));
        if (layer.overrideBlendFactors)
        {
            EditorGUILayout.PropertyField(_propSrcBlendFactor, new GUIContent("Src Factor"));
            EditorGUILayout.PropertyField(_propDstBlendFactor, new GUIContent("Dst Factor"));
        }
#endif
