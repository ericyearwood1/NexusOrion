...
internal static class OVRMovementTool
{
    ...
    private const string arkitBlendshapesFormat = "Format: ARKit Blendshapes";

    [MenuItem(k_SetupCharacterForFaceTrackingMovementToolsMenuStr + arkitBlendshapesFormat, true)]
    private static bool ValidateSetupCharacterForARKitBodyTracking()
    {
        return Selection.activeGameObject != null;
    }

    [MenuItem(k_SetupCharacterForFaceTrackingMovementToolsMenuStr + arkitBlendshapesFormat)]
    private static void SetupCharacterForARKitBlendshapesFaceTracking()
    {
        try
        {
            ValidateGameObjectFaceRetargeting(Selection.activeGameObject);
        ...
        SetUpCharacterForFaceTracking(OVRCustomFace.RetargetingType.ARKitBlendshapes);
    }

    private const string visemesFormat = "Format: Visemes";

    [MenuItem(k_SetupCharacterForFaceTrackingMovementToolsMenuStr + visemesFormat, true)]
    private static bool ValidateSetupCharacterForVisemeFaceTracking()
    {
        return Selection.activeGameObject != null;
    }
#endif
