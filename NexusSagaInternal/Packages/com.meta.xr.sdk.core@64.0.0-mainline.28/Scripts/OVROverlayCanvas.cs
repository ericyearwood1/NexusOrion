...
public class OVROverlayCanvas : OVRRayTransformer
{
    ...
    void Start()
    {
        ...
        // Ideally this would be public, because semi-transparency doesn't
        // work on mobile without it.
        _overlay.overrideBlendFactors = true;
        _overlay.srcBlendFactor = OVRPlugin.BlendFactor.One;
#endif
