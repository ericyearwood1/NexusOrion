...
public struct OVRGLTFScene
{
    ...
    public float jsonParsingDurationMs;
#endif
}
...
#if OVR_INTERNAL_CODE
        var jsonParsingStart = Time.realtimeSinceStartup;
#endif
...
#if OVR_INTERNAL_CODE
        scene.jsonParsingDurationMs = (Time.realtimeSinceStartup - jsonParsingStart) * 1000.0f;
#endif
