...
{
#if OVR_INTERNAL_CODE
    private static readonly ProfilerMarker _updateTexturesMarker =
        new ProfilerMarker("OVRVirtualKeyboard.UpdateTextures");
    private static readonly ProfilerMarker _updateTextureMarker =
        new ProfilerMarker("OVRVirtualKeyboard.UpdateTexture");
    private static readonly ProfilerMarker _updateAnimationStates =
        new ProfilerMarker("OVRVirtualKeyboard.UpdateAnimationStates");
    private static readonly ProfilerMarker _updateAnimationState =
        new ProfilerMarker("OVRVirtualKeyboard.UpdateAnimationState");
    private static readonly ProfilerMarker _updateAnimationMorphTargets =
        new ProfilerMarker("OVRVirtualKeyboard.UpdateAnimationMorphTargets");
#endif
    /// <summary>
...
#pragma warning restore CS0612
...
#if OVR_INTERNAL_CODE
        var loadGlbDuration = (Time.realtimeSinceStartup - start)  * 1000.0f;
        Debug.Log(String.Format("Virtual Keyboard Duration - GLTF Model Initialization: {0:0.00}ms JSON Parsing: {1:0.00}ms", loadGlbDuration, virtualKeyboardScene_.jsonParsingDurationMs));
#endif
    ...
    private void ShowKeyboard()
    {
        if (!isKeyboardCreated_)
        {
            ...
            Debug.Log("Virtual Keyboard Duration - Creation: " + (duration * 1000.0f) + " ms");
#endif
            if (result != OVRPlugin.Result.Success)
            {
#if UNITY_EDITOR
    ...
    private void UpdateAnimationState()
    {
...
#if OVR_INTERNAL_CODE
            _updateTextureMarker.End();
#endif
        }
#if OVR_INTERNAL_CODE
        _updateTexturesMarker.End();
        _updateAnimationStates.Begin();
#endif
        ...
        {
#if OVR_INTERNAL_CODE
            _updateAnimationMorphTargets.Begin();
#endif
...
#if OVR_INTERNAL_CODE
            _updateAnimationMorphTargets.End();
#endif
        }
#if OVR_INTERNAL_CODE
        _updateAnimationStates.End();
#endif
    }
