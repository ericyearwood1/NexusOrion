...
#if OVRPLUGIN_TESTING && UNITY_EDITOR && OVRPLUGIN_UNSUPPORTED_PLATFORM
...
public static partial class OVRPlugin
{
    ...
    public enum Result
    {
        ...
        /// Local group error cases
        Failure_LocalGroupInvalidGroup = -3000,
        Failure_LocalGroupInsufficientPermissions = -3001,
#endif
...
#pragma warning restore CS0618 // Type or member is obsolete
...
#if OVR_INTERNAL_CODE
    public enum WristGesture : uint
    {
        None = 0,
        PinchIndex = 0x00000001,
        PinchMiddle = 0x00000002,
        ThumbClick = 0x00000004,
        DPadUp = 0x00000008,
        DPadDown = 0x00000010,
        DPadLeft = 0x00000020,
        DPadRight = 0x00000040,
        EnumSize = 0x7FFFFFFF
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct WristbandState
    {
        public uint LWristGestures;
        public uint RWristGestures;
        public PoseStatef LWristImuPose;
        public PoseStatef RWristImuPose;
        public bool LWristImuValid;
        public bool RWristImuValid;
    }
#endif
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct HandTrackingStateInternal
    {
        public float Sigmas_0;
        public float Sigmas_1;
        public float Sigmas_2;
        public float Sigmas_3;
        public float Sigmas_4;
        public float Sigmas_5;
        public float Sigmas_6;
        public float Sigmas_7;
        public float Sigmas_8;
        public float Sigmas_9;
        public float Sigmas_10;
        public float Sigmas_11;
        public float Sigmas_12;
        public float Sigmas_13;
        public float Sigmas_14;
        public float Sigmas_15;
        public float Sigmas_16;
        public float Sigmas_17;
        public float Sigmas_18;
        public float Sigmas_19;
        public float Sigmas_20;
        public float Sigmas_21;
        public float Sigmas_22;
        public float Sigmas_23;
        public float Visibilities_0;
        public float Visibilities_1;
        public float Visibilities_2;
        public float Visibilities_3;
        public float Visibilities_4;
        public float Visibilities_5;
        public float Visibilities_6;
        public float Visibilities_7;
        public float Visibilities_8;
        public float Visibilities_9;
        public float Visibilities_10;
        public float Visibilities_11;
        public float Visibilities_12;
        public float Visibilities_13;
        public float Visibilities_14;
        public float Visibilities_15;
        public float Visibilities_16;
        public float Visibilities_17;
        public float Visibilities_18;
        public float Visibilities_19;
        public float Visibilities_20;
        public float Visibilities_21;
        public float Visibilities_22;
        public float Visibilities_23;
        public MicrogestureType Microgesture;
    }
...
#if OVR_INTERNAL_CODE
    public enum BodyTrackingFidelity
    {
        Low = 0,
        High = 1
    }
...
#if OVR_INTERNAL_CODE
    public enum BodyTrackingCalibrationStatus
    {
        Valid = 0,
        Calibrating = 1,
        Invalid = 2
    ...
    [StructLayout(LayoutKind.Sequential)]
#if OVRPLUGIN_TESTING
    public struct BodyState2Internal
#else
    private struct BodyState2Internal
#endif
    {
        public Bool IsActive;
        public float Confidence;
    ...
    [StructLayout(LayoutKind.Sequential)]
#if OVRPLUGIN_TESTING
    public struct BodyState3Internal
#else
    private struct BodyState3Internal
#endif // OVRPLUGIN_TESTING
    {
        ...
        public BodyJointLocation JointLocation_82;
        public BodyJointLocation JointLocation_83;
        public BodyTrackingCalibrationStatus CalibrationStatus;
    }
#endif // BODY_CALIBRATION
    [StructLayout(LayoutKind.Sequential)]
#if OVRPLUGIN_TESTING
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct EyeGazeInteractionsState
    {
        public EyeGazeInteractionState[] EyeGazeInteractions;
    }

    [StructLayout(LayoutKind.Sequential)]
#if OVRPLUGIN_TESTING
    public struct EyeGazeInteractionsStateInternal
#else
    private struct EyeGazeInteractionsStateInternal
#endif
    {
        public EyeGazeInteractionState EyeGazeInteractionCombined;
        public EyeGazeInteractionState EyeGazeInteractionLeft;
        public EyeGazeInteractionState EyeGazeInteractionRight;
    }
#endif
    ...
    public enum EventType
    {
...
#if OVR_INTERNAL_CODE
        CreatePlaneTrackerResults = 151,
        DestroyPlaneTrackerResults = 152,
#endif // OVR_INTERNAL_CODE
#if OVR_INTERNAL_CODE
        CreateSceneObjectTrackerResults = 161,
        DestroySceneObjectTrackerResults = 162,
#endif // OVR_INTERNAL_CODE
#if OVR_INTERNAL_CODE
        CreateSceneReconstructionTrackerResults = 171,
        DestroySceneReconstructionTrackerResults = 172,
        UpdateSceneReconstructionTrackerSettingsResults = 173,
        UpdateSceneReconstructionTrackerRoomboxResults = 174,
#endif // OVR_INTERNAL_CODE
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
        LocalGroupStartComplete = 350,
        LocalGroupDiscoveryComplete = 351,
        LocalGroupDiscoveredResult = 352,
        LocalGroupJoinComplete = 353,
        LocalGroupLeaveComplete = 354,
        LocalGroupParticipantJoined = 355,
        LocalGroupParticipantLeft = 356,
        LocalGroupSetDiscoverabilityModeComplete = 357,
        LocalGroupSetAppInfoComplete = 358,
        LocalGroupParticipantSetAppInfoComplete = 359,
        LocalGroupDiscoverabilityModeUpdated = 360,
        LocalGroupAppInfoUpdated = 361,
        LocalGroupParticipantAppInfoUpdated = 362,
        LocalGroupParticipantsQueryResultsReady = 363,

        // Local Group Sharing events
        LocalGroupShareSpacesComplete = 400,
        LocalGroupSpacesShared = 401,
        ...
        ReturnToRoomUserLocationChanged = 600,
#endif

#if OVR_INTERNAL_CODE // TODO - remove redaction before public release (T175611441)
        CreateDynamicObjectTrackerResults = 650,
        SetDynamicObjectTrackedClassesResults = 651,
#endif // OVR_INTERNAL_CODE
    }
    ...
    public enum SpaceComponentType
    {
        ...
        RoomLayout = 6,
#if OVR_INTERNAL_CODE
        SpatialEntityContainer = 7, // Deprecated
#endif
        SpaceContainer = 7,
        TriangleMesh = 1000269000,
#if OVR_INTERNAL_CODE
        RoomLabel = 1000293001,
#endif
    }
...
#if OVR_INTERNAL_CODE
    [System.Obsolete("Deprecated. Please use SpatialAnchorCreateInfo", false)]
    [StructLayout(LayoutKind.Sequential)]
    public struct SpaceAnchorCreateInfo
    {
        public TrackingOrigin BaseTracking;
        public Posef PoseInSpace;
        public double Time;
    ...
    [System.Obsolete("Deprecated. Please use System.Guid", false)]
    [StructLayout(LayoutKind.Sequential)]
    ...
    // Local Group Filter Types
    [StructLayout(LayoutKind.Sequential)]
    public struct SpaceFilterInfoLocalGroup
    {
    ...
    public struct SpaceQueryInfo2
    {
        ...
        public SpaceFilterInfoIds IdInfo;
        public SpaceFilterInfoComponents ComponentsInfo;
        public SpaceFilterInfoLocalGroup LocalGroupInfo;
    }
    ...
    public enum FiducialPayloadType
    {
        None = 0,
        String = 1,
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct FiducialState
    {
        public Guid id;
        public FiducialType fiducialType;
        public UInt64 lastSeenTimestamp;
        public SpaceLocationf T_stageFromFiducial;
        public Sizef size;
        public FiducialPayloadType payloadType;
    }
#endif
    ...
    // This Enum values should remain synced with XrLocalGroupJoinPolicyMETAX1 values in metax1_local_group.h
    ...
    // This Enum values should remain synced with XrLocalGroupDiscoveryStopReasonMETAX1 values in metax1_local_group.h
    ...
    // This Enum values should remain synced with XrLocalGroupDiscoverabilityModeMETAX1 values in metax1_local_group.h
    public enum LocalGroupDiscoverabilityMode
    {
        Hidden = 0,
        Discoverable = 1,
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupStartInfo
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)]
        public string GroupAppInfo;

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)]
        public string CreatorParticipantAppInfo;

        public LocalGroupJoinPolicy JoinPolicy;
        public LocalGroupDiscoverabilityMode DiscoverabilityMode;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupDiscoveryStartInfo
    {
        public double MaxDiscoveryDuration;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupDiscoveryStopInfo
    {
        public UInt64 StartDiscoveryRequestId;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupJoinInfo
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)]
        public string JoinerParticipantAppInfo;

        public Guid GroupUuid;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupLeaveInfo
    {
        public Guid GroupUuid;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupSetDiscoverabilityModeInfo
    {
        public Guid GroupUuid;
        LocalGroupDiscoverabilityMode DiscoverabilityMode;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupAppInfoSetInfo
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)]
        public string GroupAppInfo;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupParticipantAppInfoSetInfo
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)]
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupParticipantsQueryInfo
    {
        public Guid GroupUuid;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupParticipantsQueryResults
    {
        public System.IntPtr Participants;
        public uint ParticipantsCount;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupParticipantInfo
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)]
        public string ParticipantAppInfo;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupParticipantsGetQueryResultsInfo
    {
        public UInt64 QueryRequestId;
        public uint ParticipantsCount;
    }

    // This Enum values should remain synced with result values within XrEventDataLocalGroupShareSpacesCompleteMETAX1 in metax1_local_group_sharing.h
    public enum LocalGroupShareSpacesResult
    {
        Success = 0,
        NetworkTimeout = -1000169002, // XR_ERROR_SPACE_NETWORK_TIMEOUT_FB
        NetworkRequestFailed = -1000169003, // XR_ERROR_SPACE_NETWORK_REQUEST_FAILED_FB
        InvalidGroup = -1000272000, // XR_ERROR_LOCAL_GROUP_SHARING_INVALID_GROUP_METAX1
        InsufficientPermissions = -1000272001, // XR_ERROR_LOCAL_GROUP_SHARING_INSUFFICIENT_PERMISSIONS_METAX1
    }

    // This Enum values should remain synced with XR_MAX_LOCAL_GROUP_SPACES_PER_SHARE_REQUEST_METAX1 values in metax1_local_group_sharing.h
    public const int MaxLocalGroupSpacesPerShareRequest = 32;

    [StructLayout(LayoutKind.Sequential)]
    public struct LocalGroupShareSpacesInfo
    {
        public Guid GroupUuid;
        public uint SpaceCount;
        public System.IntPtr Spaces;
    }

    public struct SpaceLocalGroupFilterInfo
    {
        public Guid GroupUuid;
    }
...
#if OVR_INTERNAL_CODE
        , bool overrideBlendFactors = false, BlendFactor srcBlendFactor = BlendFactor.SrcAlpha,
    ...
    )
    {
        ...
        if (version >= OVRP_1_6_0.version)
        {
            ...
            if (version >= OVRP_1_60_0.version && layerId != -1)
                return OVRP_1_60_0.ovrp_EnqueueSubmitLayer3(flags, leftTexture, rightTexture, layerId, frameIndex,
                           ref pose, ref scale, layerIndex, overrideTextureRectMatrix ? Bool.True : Bool.False,
                           ref textureRectMatrix, overridePerLayerColorScaleAndOffset ? Bool.True : Bool.False,
                           ref colorScale,
                           ref colorOffset, overrideBlendFactors ? Bool.True : Bool.False, srcBlendFactor,
                           dstBlendFactor) ==
                       Result.Success;
            else
#endif
...
#if OVR_INTERNAL_CODE
    public static WristbandState GetWristbandState()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return new WristbandState();
#else
        if (version >= OVRP_1_76_0.version)
        {
            WristbandState wristbandState = new WristbandState();
            OVRP_1_76_0.ovrp_GetWristbandState(ref wristbandState);
            return wristbandState;
        }
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE  // HAND_TRACKING_MICROGESTURES
    public static bool StartMicrogestureDetection()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        if (version >= OVRP_1_91_0.version)
        {
            Result result = OVRP_1_91_0.ovrp_StartMicrogestureDetection();
            if (result == Result.Success)
            {
                return true;
            }
    ...
    public static bool StopMicrogestureDetection()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        if (version >= OVRP_1_91_0.version)
        {
            Result result = OVRP_1_91_0.ovrp_StopMicrogestureDetection();
            if (result == Result.Success)
            {
                return true;
            }
    ...
    public static bool SetHandSkeletonVersion(OVRHandSkeletonVersion skeletonVersion)
    {
        ...
        {
            Result result = OVRP_1_95_0.ovrp_SetHandSkeletonVersion(skeletonVersion);
            return result == Result.Success;
        }
        return false;
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE  // Hands3.0  To be removed when wide motion mode fully ships
    public static bool SetBodyFusionHandPoses(bool bodyFusionHandPoses)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        if (version >= OVRP_1_89_0.version)
        {
            Result result = OVRP_1_89_0.ovrp_SetBodyFusionHandPoses(bodyFusionHandPoses ? Bool.True : Bool.False);
            return (result == Result.Success);
        }
    ...
    public static bool IsBodyFusionHandPosesEnabled()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        ...
        {
            Bool enabled = OVRPlugin.Bool.False;
            Result result = OVRP_1_89_0.ovrp_IsBodyFusionHandPosesEnabled(ref enabled);
            if (result == Result.Success)
            {
                return enabled == OVRPlugin.Bool.True;
            }
            ...
            //Debug.LogError(
            //    "Unable to determine if controller driven hand poses are enabled. Try calling IsBodyFusionHandPosesEnabled() " +
            //    "while the XR plug-in is initialized. Failed with reason: " + result);
            return false;
        }
        else
...
#if OVR_INTERNAL_CODE
    public static bool temporalFoveatedRenderingSupported
    {
        get
        {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
            ...
            {
                Bool supported;
                Result result = OVRP_1_79_0.ovrp_GetFoveationTemporalSupported(out supported);
                if (result != Result.Success)
                {
                    //Debug.LogWarning("ovrp_GetFoveationTemporalSupported return " + result);
                }
    ...
    public static bool temporalFoveatedRenderingEnabled
    {
        get
        {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
            return false;
#else
            if (version >= OVRP_1_79_0.version && temporalFoveatedRenderingSupported)
            {
                Bool isTemporal = Bool.False;
                Result result = OVRP_1_79_0.ovrp_GetFoveationTemporal(out isTemporal);
                if (result != Result.Success)
                {
                    //Debug.LogWarning("ovrp_GetFoveationTemporal return " + result);
                }

                return isTemporal == Bool.True;
            }
            else
            {
                return false;
        ...
        set
        {
            ...
            if (version >= OVRP_1_79_0.version && temporalFoveatedRenderingSupported)
            {
                Result result = OVRP_1_79_0.ovrp_SetFoveationTemporal(value ? Bool.True : Bool.False);
                if (result != Result.Success)
                {
                    //Debug.LogWarning("ovrp_SetFoveationTemporal return " + result);
                }
            }
#endif
        }
...
#if OVR_INTERNAL_CODE
                switch (OVRManager._handSkeletonVersion)
                {
                    case OVRHandSkeletonVersion.V1:
#endif
...
#if OVR_INTERNAL_CODE
                        break;
                    case OVRHandSkeletonVersion.V2:
                        Quaternion boneRotator = (hand == Hand.HandLeft ? LeftBoneRotator : RightBoneRotator);

                        handState.BoneRotations[0] = (cachedHandState.BoneRotations_0.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[1] = (cachedHandState.BoneRotations_1.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[2] = (cachedHandState.BoneRotations_2.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[3] = (cachedHandState.BoneRotations_3.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[4] = (cachedHandState.BoneRotations_4.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[5] = (cachedHandState.BoneRotations_5.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[6] = (cachedHandState.BoneRotations_6.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[7] = (cachedHandState.BoneRotations_7.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[8] = (cachedHandState.BoneRotations_8.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[9] = (cachedHandState.BoneRotations_9.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[10] = (cachedHandState.BoneRotations_10.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[11] = (cachedHandState.BoneRotations_11.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[12] = (cachedHandState.BoneRotations_12.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[13] = (cachedHandState.BoneRotations_13.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[14] = (cachedHandState.BoneRotations_14.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[15] = (cachedHandState.BoneRotations_15.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[16] = (cachedHandState.BoneRotations_16.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[17] = (cachedHandState.BoneRotations_17.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[18] = (cachedHandState.BoneRotations_18.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[19] = (cachedHandState.BoneRotations_19.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[20] = (cachedHandState.BoneRotations_20.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[21] = (cachedHandState.BoneRotations_21.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[22] = (cachedHandState.BoneRotations_22.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        handState.BoneRotations[23] = (cachedHandState.BoneRotations_23.FromFlippedZQuatf() * boneRotator).ToQuatf();
                        break;
                }
#endif // OVR_INTERNAL_CODE
    ...
    public static bool GetHandTrackingState(Step stepId, Hand hand, ref HandTrackingState handTrackingState)
    {
        ...
        Result res = OVRP_1_81_0.ovrp_GetHandTrackingState(stepId, -1, hand, out cachedHandTrackingState);
        if (res != Result.Success)
        {
            return false;
        }

        if (handTrackingState.Sigmas == null || handTrackingState.Sigmas.Length != (int)SkeletonConstants.MaxHandBones)
        {
            handTrackingState.Sigmas = new float[(int)SkeletonConstants.MaxHandBones];
        }

        if (handTrackingState.Visibilities == null ||
            handTrackingState.Visibilities.Length != (int)SkeletonConstants.MaxHandBones)
        {
            handTrackingState.Visibilities = new float[(int)SkeletonConstants.MaxHandBones];
        }

        handTrackingState.Sigmas[0] = cachedHandTrackingState.Sigmas_0;
        handTrackingState.Sigmas[1] = cachedHandTrackingState.Sigmas_1;
        handTrackingState.Sigmas[2] = cachedHandTrackingState.Sigmas_2;
        handTrackingState.Sigmas[3] = cachedHandTrackingState.Sigmas_3;
        handTrackingState.Sigmas[4] = cachedHandTrackingState.Sigmas_4;
        handTrackingState.Sigmas[5] = cachedHandTrackingState.Sigmas_5;
        handTrackingState.Sigmas[6] = cachedHandTrackingState.Sigmas_6;
        handTrackingState.Sigmas[7] = cachedHandTrackingState.Sigmas_7;
        handTrackingState.Sigmas[8] = cachedHandTrackingState.Sigmas_8;
        handTrackingState.Sigmas[9] = cachedHandTrackingState.Sigmas_9;
        handTrackingState.Sigmas[10] = cachedHandTrackingState.Sigmas_10;
        handTrackingState.Sigmas[11] = cachedHandTrackingState.Sigmas_11;
        handTrackingState.Sigmas[12] = cachedHandTrackingState.Sigmas_12;
        handTrackingState.Sigmas[13] = cachedHandTrackingState.Sigmas_13;
        handTrackingState.Sigmas[14] = cachedHandTrackingState.Sigmas_14;
        handTrackingState.Sigmas[15] = cachedHandTrackingState.Sigmas_15;
        handTrackingState.Sigmas[16] = cachedHandTrackingState.Sigmas_16;
        handTrackingState.Sigmas[17] = cachedHandTrackingState.Sigmas_17;
        handTrackingState.Sigmas[18] = cachedHandTrackingState.Sigmas_18;
        handTrackingState.Sigmas[19] = cachedHandTrackingState.Sigmas_19;
        handTrackingState.Sigmas[20] = cachedHandTrackingState.Sigmas_20;
        handTrackingState.Sigmas[21] = cachedHandTrackingState.Sigmas_21;
        handTrackingState.Sigmas[22] = cachedHandTrackingState.Sigmas_22;
        handTrackingState.Sigmas[23] = cachedHandTrackingState.Sigmas_23;
        handTrackingState.Visibilities[0] = cachedHandTrackingState.Visibilities_0;
        handTrackingState.Visibilities[1] = cachedHandTrackingState.Visibilities_1;
        handTrackingState.Visibilities[2] = cachedHandTrackingState.Visibilities_2;
        handTrackingState.Visibilities[3] = cachedHandTrackingState.Visibilities_3;
        handTrackingState.Visibilities[4] = cachedHandTrackingState.Visibilities_4;
        handTrackingState.Visibilities[5] = cachedHandTrackingState.Visibilities_5;
        handTrackingState.Visibilities[6] = cachedHandTrackingState.Visibilities_6;
        handTrackingState.Visibilities[7] = cachedHandTrackingState.Visibilities_7;
        handTrackingState.Visibilities[8] = cachedHandTrackingState.Visibilities_8;
        handTrackingState.Visibilities[9] = cachedHandTrackingState.Visibilities_9;
        handTrackingState.Visibilities[10] = cachedHandTrackingState.Visibilities_10;
        handTrackingState.Visibilities[11] = cachedHandTrackingState.Visibilities_11;
        handTrackingState.Visibilities[12] = cachedHandTrackingState.Visibilities_12;
        handTrackingState.Visibilities[13] = cachedHandTrackingState.Visibilities_13;
        handTrackingState.Visibilities[14] = cachedHandTrackingState.Visibilities_14;
        handTrackingState.Visibilities[15] = cachedHandTrackingState.Visibilities_15;
        handTrackingState.Visibilities[16] = cachedHandTrackingState.Visibilities_16;
        handTrackingState.Visibilities[17] = cachedHandTrackingState.Visibilities_17;
        handTrackingState.Visibilities[18] = cachedHandTrackingState.Visibilities_18;
        handTrackingState.Visibilities[19] = cachedHandTrackingState.Visibilities_19;
        handTrackingState.Visibilities[20] = cachedHandTrackingState.Visibilities_20;
        handTrackingState.Visibilities[21] = cachedHandTrackingState.Visibilities_21;
        handTrackingState.Visibilities[22] = cachedHandTrackingState.Visibilities_22;
        handTrackingState.Visibilities[23] = cachedHandTrackingState.Visibilities_23;
...
#if OVR_INTERNAL_CODE
    public static bool fullBodyTrackingEnabled =>
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        false;
#else
        version >= OVRP_1_84_0.version &&
        OVRP_1_84_0.ovrp_GetFullBodyTrackingEnabled(out var value) == Result.Success &&
        value == Bool.True;
#endif
#endif // FULL BODY
...
#if OVR_INTERNAL_CODE
    public static bool GetBodyState2(Step stepId, BodyJointSet jointSet, ref BodyState bodyState)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        ...
        if (version >= OVRP_1_90_0.version)
        {
            ...
            // Use v3 API which contains the body calibration status along with the full body joints
            var result = OVRP_1_90_0.ovrp_GetBodyState3(stepId, -1, out var bodyState3Internal);
            if (result != Result.Success) return false;
            if (bodyState3Internal.IsActive != Bool.True) return false;

            bodyState.Confidence = bodyState3Internal.Confidence;
            bodyState.SkeletonChangedCount = bodyState3Internal.SkeletonChangedCount;
            bodyState.Time = bodyState3Internal.Time;
            bodyState.JointLocations[0] = bodyState3Internal.JointLocation_0;
            bodyState.JointLocations[1] = bodyState3Internal.JointLocation_1;
            bodyState.JointLocations[2] = bodyState3Internal.JointLocation_2;
            bodyState.JointLocations[3] = bodyState3Internal.JointLocation_3;
            bodyState.JointLocations[4] = bodyState3Internal.JointLocation_4;
            bodyState.JointLocations[5] = bodyState3Internal.JointLocation_5;
            bodyState.JointLocations[6] = bodyState3Internal.JointLocation_6;
            bodyState.JointLocations[7] = bodyState3Internal.JointLocation_7;
            bodyState.JointLocations[8] = bodyState3Internal.JointLocation_8;
            bodyState.JointLocations[9] = bodyState3Internal.JointLocation_9;
            bodyState.JointLocations[10] = bodyState3Internal.JointLocation_10;
            bodyState.JointLocations[11] = bodyState3Internal.JointLocation_11;
            bodyState.JointLocations[12] = bodyState3Internal.JointLocation_12;
            bodyState.JointLocations[13] = bodyState3Internal.JointLocation_13;
            bodyState.JointLocations[14] = bodyState3Internal.JointLocation_14;
            bodyState.JointLocations[15] = bodyState3Internal.JointLocation_15;
            bodyState.JointLocations[16] = bodyState3Internal.JointLocation_16;
            bodyState.JointLocations[17] = bodyState3Internal.JointLocation_17;
            bodyState.JointLocations[18] = bodyState3Internal.JointLocation_18;
            bodyState.JointLocations[19] = bodyState3Internal.JointLocation_19;
            bodyState.JointLocations[20] = bodyState3Internal.JointLocation_20;
            bodyState.JointLocations[21] = bodyState3Internal.JointLocation_21;
            bodyState.JointLocations[22] = bodyState3Internal.JointLocation_22;
            bodyState.JointLocations[23] = bodyState3Internal.JointLocation_23;
            bodyState.JointLocations[24] = bodyState3Internal.JointLocation_24;
            bodyState.JointLocations[25] = bodyState3Internal.JointLocation_25;
            bodyState.JointLocations[26] = bodyState3Internal.JointLocation_26;
            bodyState.JointLocations[27] = bodyState3Internal.JointLocation_27;
            bodyState.JointLocations[28] = bodyState3Internal.JointLocation_28;
            bodyState.JointLocations[29] = bodyState3Internal.JointLocation_29;
            bodyState.JointLocations[30] = bodyState3Internal.JointLocation_30;
            bodyState.JointLocations[31] = bodyState3Internal.JointLocation_31;
            bodyState.JointLocations[32] = bodyState3Internal.JointLocation_32;
            bodyState.JointLocations[33] = bodyState3Internal.JointLocation_33;
            bodyState.JointLocations[34] = bodyState3Internal.JointLocation_34;
            bodyState.JointLocations[35] = bodyState3Internal.JointLocation_35;
            bodyState.JointLocations[36] = bodyState3Internal.JointLocation_36;
            bodyState.JointLocations[37] = bodyState3Internal.JointLocation_37;
            bodyState.JointLocations[38] = bodyState3Internal.JointLocation_38;
            bodyState.JointLocations[39] = bodyState3Internal.JointLocation_39;
            bodyState.JointLocations[40] = bodyState3Internal.JointLocation_40;
            bodyState.JointLocations[41] = bodyState3Internal.JointLocation_41;
            bodyState.JointLocations[42] = bodyState3Internal.JointLocation_42;
            bodyState.JointLocations[43] = bodyState3Internal.JointLocation_43;
            bodyState.JointLocations[44] = bodyState3Internal.JointLocation_44;
            bodyState.JointLocations[45] = bodyState3Internal.JointLocation_45;
            bodyState.JointLocations[46] = bodyState3Internal.JointLocation_46;
            bodyState.JointLocations[47] = bodyState3Internal.JointLocation_47;
            bodyState.JointLocations[48] = bodyState3Internal.JointLocation_48;
            bodyState.JointLocations[49] = bodyState3Internal.JointLocation_49;
            bodyState.JointLocations[50] = bodyState3Internal.JointLocation_50;
            bodyState.JointLocations[51] = bodyState3Internal.JointLocation_51;
            bodyState.JointLocations[52] = bodyState3Internal.JointLocation_52;
            bodyState.JointLocations[53] = bodyState3Internal.JointLocation_53;
            bodyState.JointLocations[54] = bodyState3Internal.JointLocation_54;
            bodyState.JointLocations[55] = bodyState3Internal.JointLocation_55;
            bodyState.JointLocations[56] = bodyState3Internal.JointLocation_56;
            bodyState.JointLocations[57] = bodyState3Internal.JointLocation_57;
            bodyState.JointLocations[58] = bodyState3Internal.JointLocation_58;
            bodyState.JointLocations[59] = bodyState3Internal.JointLocation_59;
            bodyState.JointLocations[60] = bodyState3Internal.JointLocation_60;
            bodyState.JointLocations[61] = bodyState3Internal.JointLocation_61;
            bodyState.JointLocations[62] = bodyState3Internal.JointLocation_62;
            bodyState.JointLocations[63] = bodyState3Internal.JointLocation_63;
            bodyState.JointLocations[64] = bodyState3Internal.JointLocation_64;
            bodyState.JointLocations[65] = bodyState3Internal.JointLocation_65;
            bodyState.JointLocations[66] = bodyState3Internal.JointLocation_66;
            bodyState.JointLocations[67] = bodyState3Internal.JointLocation_67;
            bodyState.JointLocations[68] = bodyState3Internal.JointLocation_68;
            bodyState.JointLocations[69] = bodyState3Internal.JointLocation_69;
            if (requestedFullBody)
            {
                bodyState.JointLocations[70] = bodyState3Internal.JointLocation_70;
                bodyState.JointLocations[71] = bodyState3Internal.JointLocation_71;
                bodyState.JointLocations[72] = bodyState3Internal.JointLocation_72;
                bodyState.JointLocations[73] = bodyState3Internal.JointLocation_73;
                bodyState.JointLocations[74] = bodyState3Internal.JointLocation_74;
                bodyState.JointLocations[75] = bodyState3Internal.JointLocation_75;
                bodyState.JointLocations[76] = bodyState3Internal.JointLocation_76;
                bodyState.JointLocations[77] = bodyState3Internal.JointLocation_77;
                bodyState.JointLocations[78] = bodyState3Internal.JointLocation_78;
                bodyState.JointLocations[79] = bodyState3Internal.JointLocation_79;
                bodyState.JointLocations[80] = bodyState3Internal.JointLocation_80;
                bodyState.JointLocations[81] = bodyState3Internal.JointLocation_81;
                bodyState.JointLocations[82] = bodyState3Internal.JointLocation_82;
                bodyState.JointLocations[83] = bodyState3Internal.JointLocation_83;
            }

            switch (bodyState3Internal.CalibrationStatus)
            {
                case BodyTrackingCalibrationStatus.Valid:
                    bodyState.CalibrationStatus = BodyTrackingCalibrationState.Valid;
                    break;
                case BodyTrackingCalibrationStatus.Calibrating:
                    bodyState.CalibrationStatus = BodyTrackingCalibrationState.Calibrating;
                    break;
                case BodyTrackingCalibrationStatus.Invalid:
                    bodyState.CalibrationStatus = BodyTrackingCalibrationState.Invalid;
                    break;
            }
...
#if OVR_INTERNAL_CODE
    public static Result GetKeyboardRawContrastParams(UInt64 trackedKeyboardId,
    ...
    public static Result GetTrackedKeyboardDimensions(out Vector3 dimensions)
    {
        dimensions = default;
        ...
        if (version >= OVRP_1_93_0.version)
        {
            return OVRP_1_93_0.ovrp_GetTrackedKeyboardDimensions(out dimensions);
        }
...
#if OVR_INTERNAL_CODE
    /// <summary>
    /// Face Tracking model version
    /// </summary>
    public static bool GetFaceTrackingModelVersion(out int major, out int minor, out int patch)
    {
        major = 0;
        minor = 0;
        patch = 0;
        ...
        return false;
#else
        return version >= OVRP_1_82_0.version &&
               OVRP_1_82_0.ovrp_GetFaceTrackingModelVersion(out major, out minor, out patch) == Result.Success;
#endif
    }
#endif // OVR_INTERNAL_CODE
...
#if OVR_INTERNAL_CODE // OVR_EYE_GAZE_INTERACTION
    private static EyeGazeInteractionsStateInternal cachedEyeGazeInteractionsState =
        new EyeGazeInteractionsStateInternal();

    public static bool GetEyeGazeInteractionsState(Step stepId, int frameIndex,
        ref EyeGazeInteractionsState eyeGazeInteractionsState)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
     return false;
#else
        ...
        {
            Result res =
                OVRP_1_79_0.ovrp_GetEyeGazeInteractionsState(stepId, frameIndex, out cachedEyeGazeInteractionsState);
            if (res == Result.Success)
            {
                // attempt to avoid allocations if client provides appropriately pre-initialized HandState
                if (eyeGazeInteractionsState.EyeGazeInteractions == null ||
                    eyeGazeInteractionsState.EyeGazeInteractions.Length != (int)EyeInteraction.Count)
                {
                    eyeGazeInteractionsState.EyeGazeInteractions =
                        new EyeGazeInteractionState[(int)EyeInteraction.Count];
                }

                // unrolling the arrays is necessary to avoid per-frame allocations during marshaling
                eyeGazeInteractionsState.EyeGazeInteractions[(int)EyeInteraction.Combined] =
                    cachedEyeGazeInteractionsState.EyeGazeInteractionCombined;
                eyeGazeInteractionsState.EyeGazeInteractions[(int)EyeInteraction.Left] =
                    cachedEyeGazeInteractionsState.EyeGazeInteractionLeft;
                eyeGazeInteractionsState.EyeGazeInteractions[(int)EyeInteraction.Right] =
                    cachedEyeGazeInteractionsState.EyeGazeInteractionRight;
                return true;
            }
            else
            {
                Debug.LogWarning("EyeTrack GetEyeGazeInteractionsState failed");
                return false;
            }
        }
        else
...
#if OVR_INTERNAL_CODE
    public static bool SuggestBodyTrackingFidelity(BodyTrackingFidelity bodyTrackingFidelity) =>
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        false;
#else
        version >= OVRP_1_84_0.version && OVRP_1_84_0.ovrp_SuggestBodyTrackingFidelity(bodyTrackingFidelity) == Result.Success;
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
#endif // BODY_FIDELITY
...
#if OVR_INTERNAL_CODE
    public static bool SuggestBodyTrackingCalibration(BodyTrackingCalibrationInfo calibrationInfo) =>
#if OVRPUGIN_UNSUPPORTED_PLATFORM
        false;
#else
        version >= OVRP_1_90_0.version && OVRP_1_90_0.ovrp_SuggestBodyTrackingCalibration(calibrationInfo) == Result.Success;
    ...
    public static bool QuerySpaces2(SpaceQueryInfo2 queryInfo, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
        ...
        if (version >= OVRP_1_86_0.version)
        {
            ...
            Result result = OVRP_1_86_0.ovrp_QuerySpaces2(ref queryInfo, out requestId);
            return (result == Result.Success);
        }
        else
        {
...
#if OVR_INTERNAL_CODE
    [StructLayout(LayoutKind.Sequential)]
    public struct PlaneTrackerBaseCreateInfo
    {
    }
    ...
    public struct HeightMap
    {
        ...
        public int rows;
        public int cols;
        public Vector2f originOffset;
        public float cellSize;
    }

    [StructLayout(LayoutKind.Sequential)]
#if OVRPLUGIN_TESTING
    public unsafe struct HeightMapInternal
#else
    private unsafe struct HeightMapInternal
#endif // OVRPLUGIN_TESTING
    {
        public int heightMapCapacityInput;
        public int heightMapSizeOutput;
    ...
    public static Result CreatePlaneTracker(PlaneTrackerBaseCreateInfo createInfo, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version >= OVRP_1_73_0.version)
        {
            return OVRP_1_73_0.ovrp_CreatePlaneTracker(ref createInfo, out requestId);
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    public static Result DestroyPlaneTracker(out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        if (version >= OVRP_1_73_0.version)
        {
            return OVRP_1_73_0.ovrp_DestroyPlaneTracker(out requestId);
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    public static bool planeTrackingSupported =>
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        false;
#else
        version >= OVRP_1_79_0.version &&
        OVRP_1_79_0.ovrp_GetPlaneTrackingSupported(out var value) == Result.Success &&
        value == Bool.True;
#endif

#if OVR_INTERNAL_CODE
    public static bool GetLayerVisibility(LayerDesc layerDesc,
        Posef posf,
        Vector3f scale,
        bool overrideTextureRect,
        ref TextureRectMatrixf textureMatrix,
        out float layerVisibility)
    {
        ...
        float visibility;
        if (version >= OVRP_1_79_0.version &&
            OVRP_1_79_0.ovrp_GetLayerVisibility(
                layerDesc,
                posf,
                scale,
                overrideTextureRect ? Bool.True : Bool.False,
                ref textureMatrix,
                out visibility) == Result.Success)
        {
    ...
    public static unsafe Result GetSpaceHeightMap(UInt64 space, out HeightMap heightMap, Allocator allocator)
    {
        heightMap = new HeightMap();
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_73_0.version) return Result.Failure_Unsupported;

        var heightMapInternal = default(HeightMapInternal);
        Result result = OVRP_1_73_0.ovrp_GetSpaceHeightMap(ref space, ref heightMapInternal);
        if (result != Result.Success) return result;

        var heights = new NativeArray<float>(heightMapInternal.heightMapSizeOutput, allocator);
        heightMapInternal.heightMapCapacityInput = heightMapInternal.heightMapSizeOutput;
        heightMapInternal.heights = (float*)heights.GetUnsafePtr();
        result = OVRP_1_73_0.ovrp_GetSpaceHeightMap(ref space, ref heightMapInternal);
        if (result != Result.Success) return result;

        heightMap.heights = heights;
        heightMap.rows = heightMapInternal.rows;
        heightMap.cols = heightMapInternal.cols;
        heightMap.originOffset = heightMapInternal.originOffset;
        heightMap.cellSize = heightMapInternal.cellSize;
...
#if OVR_INTERNAL_CODE
    [StructLayout(LayoutKind.Sequential)]
    public struct SceneObjectTrackerBaseCreateInfo
    {
    }

    public static Result CreateSceneObjectTracker(SceneObjectTrackerBaseCreateInfo createInfo, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_82_0.version) return Result.Failure_Unsupported;

        return OVRP_1_82_0.ovrp_CreateSceneObjectTracker(ref createInfo, out requestId);
#endif
    }

    public static Result DestroySceneObjectTracker(out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        return OVRP_1_82_0.ovrp_DestroySceneObjectTracker(out requestId);
#endif
    }
#endif
...
#if OVR_INTERNAL_CODE
    public enum SceneReconstructionTrackerFusionMode
    {
        Active = 0,
        Inactive = 1,
        EnumSize = 0x7FFFFFFF
    ...
    public enum SceneReconstructionTrackerMeshMode
    {
        None = 0,
        Raw = 1,
        Resampled = 2,
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct SceneReconstructionTrackerBaseCreateInfo
    {
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct SceneReconstructionTrackerSettingsUpdateInfo
    {
        public SceneReconstructionTrackerFusionMode fusionMode;
        public SceneReconstructionTrackerMeshMode meshMode;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct SceneReconstructionTrackerRoomboxUpdateInfo
    {
        public int wallVertexCount;
        public Vector3[] wallVertices;
    }

    public static Result CreateSceneReconstructionTracker(SceneReconstructionTrackerBaseCreateInfo createInfo, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_86_0.version) return Result.Failure_Unsupported;

        return OVRP_1_86_0.ovrp_CreateSceneReconstructionTracker(ref createInfo, out requestId);
#endif
    }

    public static Result DestroySceneReconstructionTracker(out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        return OVRP_1_86_0.ovrp_DestroySceneReconstructionTracker(out requestId);
#endif
    }

    public static Result UpdateSceneReconstructionTrackerSettings(SceneReconstructionTrackerSettingsUpdateInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_91_0.version) return Result.Failure_Unsupported;

        return OVRP_1_91_0.ovrp_UpdateSceneReconstructionTrackerSettings(ref info, out requestId);
#endif
    }

    public static Result UpdateSceneReconstructionTrackerRoombox(SceneReconstructionTrackerRoomboxUpdateInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        return OVRP_1_91_0.ovrp_UpdateSceneReconstructionTrackerRoombox(ref info, out requestId);
#endif
    }
#endif // OVR_INTERNAL_CODE
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
    // Local Group
    public static Result StartLocalGroup(LocalGroupStartInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_StartLocalGroup(ref info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result StartLocalGroupDiscovery(LocalGroupDiscoveryStartInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_StartLocalGroupDiscovery(ref info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static bool StopLocalGroupDiscovery(LocalGroupDiscoveryStopInfo info)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_StopLocalGroupDiscovery(ref info) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static Result JoinLocalGroup(LocalGroupJoinInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_JoinLocalGroup(ref info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result LeaveLocalGroup(LocalGroupLeaveInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_LeaveLocalGroup(ref info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static bool SetLocalGroupDiscoverabilityMode(LocalGroupSetDiscoverabilityModeInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_SetLocalGroupDiscoverabilityMode(ref info, out requestId) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static Result SetLocalGroupAppInfo(LocalGroupAppInfoSetInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_SetLocalGroupAppInfo(ref info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result SetLocalGroupParticipantAppInfo(LocalGroupParticipantAppInfoSetInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_SetLocalGroupParticipantAppInfo(ref info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static bool QueryLocalGroupParticipants(LocalGroupParticipantsQueryInfo info, out UInt64 requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            return OVRP_1_84_0.ovrp_QueryLocalGroupParticipants(ref info, out requestId) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static bool GetLocalGroupParticipantsQueryResults(LocalGroupParticipantsGetQueryResultsInfo info,
        out LocalGroupParticipantInfo[] participants)
    {
        participants = null;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
        ...
        if (version >= OVRP_1_84_0.version)
        {
            Int32 participantInfoSize = Marshal.SizeOf(typeof(LocalGroupParticipantInfo));
            UInt32 participantsCount = info.ParticipantsCount;
            Int32 paticipantsSizeInBytes = Convert.ToInt32(participantsCount) * participantInfoSize;
            IntPtr participantsPtr = Marshal.AllocHGlobal(paticipantsSizeInBytes);
            LocalGroupParticipantsQueryResults queryResults = new LocalGroupParticipantsQueryResults
            { Participants = participantsPtr, ParticipantsCount = participantsCount };
            Result result =
                OVRP_1_84_0.ovrp_GetLocalGroupParticipantsQueryResults(info.QueryRequestId, ref queryResults);
            if (result != Result.Success)
            {
            ...
            participants = new LocalGroupParticipantInfo[participantsCount];
            for (Int32 i = 0; i < participantsCount; i++)
            {
                LocalGroupParticipantInfo p =
                    (LocalGroupParticipantInfo)Marshal.PtrToStructure(participantsPtr + (i * participantInfoSize),
                        typeof(LocalGroupParticipantInfo));
                participants[i] = p;
            }
    ...
    public static bool FeatureFidelityGetFeatureState(FeatureType feature, out FeatureState idealState,
        out FeatureState currentState)
    {
        ...
        if (version >= OVRP_1_78_0.version)
        {
            return OVRP_1_78_0.ovrp_FeatureFidelityGetFeatureState(feature, out idealState, out currentState) ==
                   Result.Success;
        }
        else
            return false;
    ...
    // Fiducial tracker
    //-----------------------------------------------------------------
    public static bool InitializeFiducialTracking()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        Debug.LogError("[OVRPlugin.Fiducial] Unsupported platform.");
        return false;
#else
        if (version >= OVRP_1_74_0.version)
        {
            return OVRP_1_74_0.ovrp_InitializeFiducialTracking() == Result.Success;
        }
        else
        {
            Debug.LogError("[OVRPlugin.Fiducial] Wrong version. Expected=" + OVRP_1_74_0.version + ", current=" +
                           version);
            return false;
        }
#endif
    ...
    public static bool ShutdownFiducialTracking()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        if (version >= OVRP_1_74_0.version)
        {
            return OVRP_1_74_0.ovrp_ShutdownFiducialTracking() == Result.Success;
        }
        else
            return false;
#endif
    ...
    public static bool GetTrackedFiducials(out Guid[] ids)
    {
        ids = null;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
        ...
        if (version >= OVRP_1_74_0.version)
        {
            ...
            UInt32 count;
            if (OVRP_1_74_0.ovrp_GetTrackedFiducials(0, out count, IntPtr.Zero) != Result.Success)
            {
                return false;
            }

            IntPtr buffer = Marshal.AllocHGlobal((int)count * GuidSize);

            try
            {
                if (OVRP_1_74_0.ovrp_GetTrackedFiducials(count, out count, buffer) == Result.Success)
                {
                    ids = new Guid[count];
                    // Copy each element
                    for (int i = 0; i < count; ++i)
                    {
                        IntPtr offset = new IntPtr(buffer.ToInt64() + i * GuidSize);
                        ids[i] = Marshal.PtrToStructure<Guid>(offset);
                    }
    ...
    public static bool GetFiducialState(in Guid id, out FiducialState state)
    {
        state = default(FiducialState);
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        if (version >= OVRP_1_74_0.version)
        {
            return OVRP_1_74_0.ovrp_GetFiducialState(id, out state) == Result.Success;
        }
        else
            return false;
#endif
    ...
    public static bool GetFiducialPayload(in Guid fiducialId, out String payload)
    {
        ...
        {
            UInt32 payloadSize;
            Result result = OVRP_1_74_0.ovrp_GetFiducialPayload(fiducialId, 0, out payloadSize, IntPtr.Zero);
            if (result != Result.Success)
            {
                Debug.LogError("[OVRPlugin.Fiducial] Failed to get payload size. Result=" + result);
                return false;
            }

            IntPtr buffer = Marshal.AllocHGlobal((int)payloadSize);
            try
            {
                if (OVRP_1_74_0.ovrp_GetFiducialPayload(fiducialId, payloadSize, out payloadSize, buffer) ==
                    Result.Success)
                {
                    payload = Marshal.PtrToStringAnsi(buffer, checked((int)payloadSize));
                    return true;
                }
                else
                    return false;
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
    internal static Result DiscoverSpaces(in SpaceDiscoveryInfo info, out ulong requestId)
    {
        requestId = 0;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_92_0.version) return Result.Failure_NotYetImplemented;
        return OVRP_1_92_0.ovrp_DiscoverSpaces(in info, out requestId);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }
        ...
        int capacityInput, out int countOutput)
    {
        ...
        var result = OVRP_1_92_0.ovrp_RetrieveSpaceDiscoveryResults(requestId, ref info);
        countOutput = (int)info.ResultCountOutput;
        return result;
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }

    public static unsafe Result RetrieveSpaceDiscoveryResults(UInt64 requestId,
        out NativeArray<SpaceDiscoveryResult> results, Allocator allocator)
    {
        results = default;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        var result = RetrieveSpaceDiscoveryResults(requestId, null, 0, out var count);
        if (!result.IsSuccess()) return result;

        results = new NativeArray<SpaceDiscoveryResult>(count, allocator);
        result = RetrieveSpaceDiscoveryResults(requestId, (SpaceDiscoveryResult*)results.GetUnsafePtr(), results.Length, out _);
        if (!result.IsSuccess())
        {
            results.Dispose();
        }
    ...
    public static unsafe Result SaveSpaces(ulong* spaces, int count, out ulong requestId)
    {
        ...
        return Result.Failure_Unsupported;
#else
        return version < OVRP_1_92_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_92_0.ovrp_SaveSpaces((uint)count, spaces, out requestId);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }
        ...
        out UInt64 requestId)
    {
        ...
        return version < OVRP_1_92_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_92_0.ovrp_EraseSpaces(spaceCount, spaces, uuidCount, uuids, out requestId);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }
#endif // OVR_PARTNER_CODE || OVR_INTERNAL_CODE

#if OVR_INTERNAL_CODE // Room entity info
    public static unsafe Result GetSpaceRoomLabel(ulong space, uint bufferCapacityInput, out uint bufferCountOutput,
        byte* buffer)
    {
        ...
        return Result.Failure_Unsupported;
#else
        return version < OVRP_1_93_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_93_0.ovrp_GetSpaceRoomLabel(space, bufferCapacityInput, out bufferCountOutput, buffer);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }

    public static unsafe Result GetSpaceRoomLabel(ulong space, out string label)
    {
        label = string.Empty;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        var result = GetSpaceRoomLabel(space, 0, out var count, null);
        if (!result.IsSuccess()) return result;
        ...
        do
        {
            ...
            buffer = new NativeArray<byte>((int)count, Allocator.Temp);
            result = GetSpaceRoomLabel(space, (uint)buffer.Length, out count, (byte*)buffer.GetUnsafePtr());
        ...
        using (buffer)
        {
            if (result.IsSuccess())
            {
                label = Marshal.PtrToStringUTF8(new IntPtr(buffer.GetUnsafePtr()), (int)count);
            }
        }
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE // XR_META_return_to_room
    public enum ReturnToRoomUserLocation
    {
        /// <summary>
        /// User is located inside the specific room.
        /// </summary>
        Inside = 1,

        /// <summary>
        /// User is located outside the specific room.
        /// </summary>
        Outside = 2,
    }

    public static unsafe Result RequestReturnToRoom(uint roomUuidCount, Guid* uuids)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        return version < OVRP_1_93_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_93_0.ovrp_RequestReturnToRoom(roomUuidCount, uuids);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }
    ...
    public static Result RequestBoundaryVisibility(BoundaryVisibility boundaryVisibility)
    {
        ...
        return version < OVRP_1_93_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_93_0.ovrp_RequestBoundaryVisibility(boundaryVisibility);
#endif
    }
#endif // OVR_PARTNER_CODE || OVR_INTERNAL_CODE // XR_META_boundary_visibility
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct DynamicObjectTrackerCreateInfo
    {
    }

    public const int DynamicObjectTrackedClassesMaxSize = 16;

    [StructLayout(LayoutKind.Sequential)]
    public struct DynamicObjectTrackedClassesSetInfo
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = DynamicObjectTrackedClassesMaxSize)]
        public DynamicObjectClass[] classes;
    ...
    public static Result CreateDynamicObjectTracker(DynamicObjectTrackerCreateInfo createInfo)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version >= OVRP_1_95_0.version)
        {
            return OVRP_1_95_0.ovrp_CreateDynamicObjectTracker(createInfo);
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    public static Result DestroyDynamicObjectTracker()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version >= OVRP_1_95_0.version)
        {
            return OVRP_1_95_0.ovrp_DestroyDynamicObjectTracker();
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    public static Result SetDynamicObjectTrackedClasses(DynamicObjectTrackedClassesSetInfo setInfo)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version >= OVRP_1_95_0.version)
        {
            if (setInfo.classes == null || setInfo.classes.Length == 0)
            {
                Debug.LogError("No tracked dynamic object classes specified.");
                return Result.Failure_InvalidParameter;
            }
            if (setInfo.classes.Length > DynamicObjectTrackedClassesMaxSize)
            {
                Debug.LogError("Attempted to set more tracked dynamic object classes than the maximum " +
                    "number supported: " + DynamicObjectTrackedClassesMaxSize);
                return Result.Failure_InvalidParameter;
            }
            if (setInfo.classes.Length != setInfo.classCount)
            {
                Debug.LogError("setInfo.classes.Length (" + setInfo.classes.Length + ") and setInfo.classCount (" +
                    setInfo.classCount + ") mismatch");
                return Result.Failure_InvalidParameter;
            }
            // The array size must be exactly DynamicObjectTrackedClassesMaxSize for data marshaling
            if (setInfo.classes.Length != DynamicObjectTrackedClassesMaxSize)
            {
                Array.Resize(ref setInfo.classes, DynamicObjectTrackedClassesMaxSize);
            }
            return OVRP_1_95_0.ovrp_SetDynamicObjectTrackedClasses(setInfo);
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    public static Result GetSpaceDynamicObjectData(UInt64 space, out DynamicObjectData data)
    {
        ...
        if (version >= OVRP_1_95_0.version)
        {
            return OVRP_1_95_0.ovrp_GetSpaceDynamicObjectData(ref space, out data);
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    internal static Result LocalGroupShareSpaces(ref LocalGroupShareSpacesInfo info, out ulong requestId)
    {
        requestId = default;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_86_0.version) return Result.Failure_NotYetImplemented;
        return OVRP_1_86_0.ovrp_LocalGroupShareSpaces(ref info, out requestId);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }
#endif // OVR_PARTNER_CODE || OVR_INTERNAL_CODE
    ...
    public enum EnvironmentMapResolution
    {
        ...
        FaceResolution32 = 32,
        FaceResolution64 = 64,
        FaceResolution128 = 128,
        FaceResolution256 = 256,
    }

    public enum EnvironmentMapPixelFormat
    {
        Rgba16f = 0,
        Rgba32f = 1,
    }

    public enum EnvironmentMapCubeFace
    {
        PositiveX = 0,
        NegativeX = 1,
        PositiveY = 2,
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct DirectionalLightingEstimate
    {
    ...
    [StructLayout(LayoutKind.Sequential)]
    public unsafe struct EnvironmentMapLightingEstimate
    {
    ...
    private const int LightingEstimateColorCorrectionMatrixSize = 9;
    [StructLayout(LayoutKind.Sequential)]
    public unsafe struct LightingEstimateColorCorrection
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = LightingEstimateColorCorrectionMatrixSize)]
        public float[] ColorCorrectionMatrix;
    }

    public static Result StartLightingEstimation(ulong startFlags, EnvironmentMapResolution environmentMapResolution, EnvironmentMapPixelFormat environmentMapPixelFormat)
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        return version < OVRP_1_94_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_94_0.ovrp_StartLightingEstimation(startFlags, environmentMapResolution, environmentMapPixelFormat);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }

    public static Result StopLightingEstimation()
    {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        return version < OVRP_1_94_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_94_0.ovrp_StopLightingEstimation();
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }

    public static Result GetDirectionalLightingEstimate(out DirectionalLightingEstimate estimate)
    {
        estimate = default;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
        ...
        return version < OVRP_1_94_0.version
            ? Result.Failure_NotYetImplemented
            : OVRP_1_94_0.ovrp_GetDirectionalLightingEstimate(out estimate);
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }

    public static unsafe Result GetEnvironmentMapLightingEstimate(EnvironmentMapCubeFace cubeFace,
        int bufferCapacityInput, out int bufferCountOutput, ref byte[] buffer, out Posef pose)
    {
        bufferCountOutput = default;
        pose = default;
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_94_0.version)
            return Result.Failure_NotYetImplemented;

        NativeArray<byte> nativeBuffer = default;
        if (bufferCapacityInput > 0)
            nativeBuffer = new NativeArray<byte>((int)bufferCapacityInput, Allocator.Temp);

        var estimate = new EnvironmentMapLightingEstimate
        {
            BufferCapacityInput = bufferCapacityInput,
            BufferCountOutput = bufferCountOutput,
            Buffer = (byte*)nativeBuffer.GetUnsafePtr()
        };
        Result result = OVRP_1_94_0.ovrp_GetEnvironmentMapLightingEstimate(cubeFace, ref estimate);

        bufferCountOutput = estimate.BufferCountOutput;
        if (result.IsSuccess() && bufferCapacityInput > 0)
        {
            pose = estimate.Pose;
            Marshal.Copy(new IntPtr(nativeBuffer.GetUnsafePtr()), buffer, 0, bufferCountOutput);
        }
    ...
    public static unsafe Result GetLightingEstimateColorCorrection(ref float[] correction)
    {
        LightingEstimateColorCorrection correctionInt = default;
        correctionInt.ColorCorrectionMatrix = new float[LightingEstimateColorCorrectionMatrixSize];
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
        return Result.Failure_Unsupported;
#else
        if (version < OVRP_1_94_0.version)
        ...
        Result result = OVRP_1_94_0.ovrp_GetLightingEstimateColorCorrection(out correctionInt);

        if (result.IsSuccess())
        {
            correctionInt.ColorCorrectionMatrix.CopyTo(correction, 0);
        }
        return result;
#endif // OVRPLUGIN_UNSUPPORTED_PLATFORM
    }
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_0_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_38_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_55_1_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetNodeContrastParams(Step stepId, int frameIndex, Node nodeId,
            out Vector4f contrastParams);
#endif
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_EnqueueSubmitLayer3(uint flags, IntPtr textureLeft, IntPtr textureRight,
            int layerId, int frameIndex, ref Posef pose, ref Vector3f scale, int layerIndex,
            Bool overrideTextureRectMatrix, ref TextureRectMatrixf textureRectMatrix,
            Bool overridePerLayerColorScaleAndOffset, ref Vector4 colorScale, ref Vector4 colorOffset,
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetKeyboardRawContrastParams(UInt64 trackedKeyboardId,
            out KeyboardTrackingContrastParams contrastParams);
#endif
    }

#if OVRPLUGIN_TESTING
    private static class OVRP_1_72_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_73_0_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_CreatePlaneTracker(ref PlaneTrackerBaseCreateInfo createInfo,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_DestroyPlaneTracker(out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetSpaceHeightMap(ref UInt64 space, ref HeightMapInternal heightMapInternal);
#endif // OVR_INTERNAL_CODE
    }

#if OVRPLUGIN_TESTING
    private static class OVRP_1_74_0_PROD
#else
...
#endif
    {
        ...
        //-----------------------------------------------------------------
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_InitializeFiducialTracking();

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_ShutdownFiducialTracking();

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetTrackedFiducials(UInt32 bufferCapacityInput, out UInt32 bufferCountOutput,
            IntPtr buffer);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetFiducialState(Guid id, out FiducialState state);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetFiducialPayload(Guid id, UInt32 bufferCapacityInput,
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_75_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_76_0_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetWristbandState(ref WristbandState wristbandState);
#endif
    }

#if OVRPLUGIN_TESTING
    private static class OVRP_1_78_0_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_FeatureFidelitySetFeatureEnable(FeatureType feature,
            FeatureEnableState featureEnableState);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_FeatureFidelitySetFeatureFidelity(FeatureType feature,
            FeatureFidelity featureFidelity);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_FeatureFidelityGetFeatureState(FeatureType feature,
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_79_0_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetPlaneTrackingSupported(out Bool planeTrackingSupported);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetFoveationTemporalSupported(out Bool value);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetFoveationTemporal(out Bool value);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SetFoveationTemporal(Bool value);
#endif

#if OVR_INTERNAL_CODE // OVR_EYE_GAZE_INTERACTION
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetEyeGazeInteractionsState(Step stepId, int frameIndex,
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetLayerVisibility(LayerDesc layerDesc,
            Posef posf,
            Vector3f scale,
            Bool overrideTextureRect,
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_81_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_82_0_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetFaceTrackingModelVersion(out int majorVersion, out int minorVersion,
            out int patchVersion);
#endif // OVR_INTERNAL_CODE

#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_CreateSceneObjectTracker(ref SceneObjectTrackerBaseCreateInfo createInfo,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_DestroySceneObjectTracker(out UInt64 requestId);
#endif // OVR_INTERNAL_CODE
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_83_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_84_0_PROD
#else
...
#endif
    {
        ...
        // Local Group
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_StartLocalGroup(ref LocalGroupStartInfo info, out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_StartLocalGroupDiscovery(ref LocalGroupDiscoveryStartInfo info,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_StopLocalGroupDiscovery(ref LocalGroupDiscoveryStopInfo info);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_JoinLocalGroup(ref LocalGroupJoinInfo info, out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_LeaveLocalGroup(ref LocalGroupLeaveInfo info, out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SetLocalGroupDiscoverabilityMode(ref LocalGroupSetDiscoverabilityModeInfo info,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SetLocalGroupAppInfo(ref LocalGroupAppInfoSetInfo info, out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SetLocalGroupParticipantAppInfo(ref LocalGroupParticipantAppInfoSetInfo info,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_QueryLocalGroupParticipants(ref LocalGroupParticipantsQueryInfo info,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetLocalGroupParticipantsQueryResults(UInt64 queryRequestId,
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetFullBodyTrackingEnabled(out Bool fullBodyTrackingEnabled);
#endif // FULL BODY
        ...
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SuggestBodyTrackingFidelity(BodyTrackingFidelity bodyTrackingFidelity);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetBodyState2(Step stepId, int frameIndex, out BodyState2Internal bodyState);
#endif // FULL BODY
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_85_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_86_0_PROD
#else
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_LocalGroupShareSpaces(ref LocalGroupShareSpacesInfo info, out ulong requestId);
#endif

#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_CreateSceneReconstructionTracker(ref SceneReconstructionTrackerBaseCreateInfo createInfo,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_DestroySceneReconstructionTracker(out UInt64 requestId);
#endif
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_87_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_88_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_89_0_PROD
#else
...
#endif
    {
        ...
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SetBodyFusionHandPoses(Bool bodyFusionHandPoses);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_IsBodyFusionHandPosesEnabled(ref Bool enabled);
#endif
    }

#if OVRPLUGIN_TESTING
    private static class OVRP_1_90_0_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SuggestBodyTrackingCalibration(BodyTrackingCalibrationInfo calibrationInfo);
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetBodyState3(Step stepId, int frameIndex, out BodyState3Internal bodyState);
#endif // BODY_CALIBRATION
    }

#if OVRPLUGIN_TESTING
    private static class OVRP_1_91_0_PROD
#else
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE  // HAND_TRACKING_MICROGESTURES
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_StartMicrogestureDetection();

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_StopMicrogestureDetection();

#endif

#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_UpdateSceneReconstructionTrackerSettings(ref SceneReconstructionTrackerSettingsUpdateInfo info,
            out UInt64 requestId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_UpdateSceneReconstructionTrackerRoombox(ref SceneReconstructionTrackerRoomboxUpdateInfo info,
            out UInt64 requestId);
#endif
    }

#if OVRPLUGIN_TESTING
    private static class OVRP_1_92_0_PROD
#else
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_93_0_PROD
#else
...
#if OVR_INTERNAL_CODE
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetTrackedKeyboardDimensions(out Vector3 dimensions);
#endif

#if OVR_INTERNAL_CODE // Room entity info
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe Result ovrp_GetSpaceRoomLabel(ulong space, uint bufferCapacityInput, out uint bufferCountOutput, byte* buffer);
#endif

#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE // XR_META_return_to_room
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe Result ovrp_RequestReturnToRoom(uint roomUuidCount, Guid* uuids);
#endif
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_94_0_PROD
#else
...
#if OVR_INTERNAL_CODE // XR_META_lighting_estimation
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_StartLightingEstimation(ulong startFlags, EnvironmentMapResolution environmentMapResolution, EnvironmentMapPixelFormat environmentMapPixelFormat);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_StopLightingEstimation();

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetDirectionalLightingEstimate(out DirectionalLightingEstimate estimate);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe Result ovrp_GetEnvironmentMapLightingEstimate(EnvironmentMapCubeFace cubeFace, ref EnvironmentMapLightingEstimate estimate);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_GetLightingEstimateColorCorrection(out LightingEstimateColorCorrection correction);
#endif // OVR_INTERNAL_CODE // XR_META_lighting_estimation
    }

#if OVRPLUGIN_TESTING
    private static class OVRP_1_95_0_PROD
#else
...
#if OVR_INTERNAL_CODE // TODO - remove redaction before public release (T175611441)
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_CreateDynamicObjectTracker(DynamicObjectTrackerCreateInfo createInfo);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_DestroyDynamicObjectTracker();

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_SetDynamicObjectTrackedClasses(DynamicObjectTrackedClassesSetInfo setInfo);
...
#if OVRPLUGIN_TESTING
    private static class OVRP_1_96_0_PROD
#else
    ...
    // After modifying this file, run `fbpython arvr/projects/integrations/codegen/generate_mockovrplugin.py` to update OculusInternal/Tests/MockOVRPlugin.cs
#endif
}
