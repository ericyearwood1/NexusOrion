...
public class OVRScenePlaneMeshFilter : MonoBehaviour
{
    ...
    internal JobHandle? JobHandleForTesting => _jobHandle;
    internal bool MeshRequested => _meshRequested;
#endif
    ...
    private void Update()
    {
        ...
        else
        {
            throw new InvalidOperationException($"Unexpected state: " +
                                                $"{nameof(_boundary)}.IsCreated = {_boundary.IsCreated}, " +
                                                $"{nameof(_triangles)}.IsCreated = {_triangles.IsCreated}");
        }
#endif
#endif
    }
