    ...
    OVRMeshRenderer.IOVRMeshRendererDataProvider
{
    ...
    public enum MicrogestureType
    {
        ...
        SwipeTip = OVRPlugin.MicrogestureType.SwipeTip,
        SwipeKnuckle = OVRPlugin.MicrogestureType.SwipeKnuckle,
    ...
    public bool GetHandBoneSigmas(float[] boneSigmas)
    {
        if (!_handTrackingStateValid || boneSigmas.Length != _handTrackingState.Sigmas.Length)
        {
            return false;
        }

        System.Array.Copy(_handTrackingState.Sigmas, boneSigmas, boneSigmas.Length);
        return true;
    }

    public bool GetHandBoneVisibilities(float[] boneVisibilities)
    {
        if (!_handTrackingStateValid || boneVisibilities.Length != _handTrackingState.Visibilities.Length)
        {
            return false;
        }

        System.Array.Copy(_handTrackingState.Visibilities, boneVisibilities, boneVisibilities.Length);
        return true;
    }
#endif
    ...
    public MicrogestureType GetMicrogestureType()
    {
        ...
        return Enum.IsDefined(typeof(MicrogestureType), (int)_handTrackingState.Microgesture)
            ? (MicrogestureType)(int)_handTrackingState.Microgesture
