        ...
        try
        {
            ...
            switch (type)
            {
                ...
                case OVRCustomFace.RetargetingType.Custom:
                    ...
                    break;
#if OVR_INTERNAL_CODE
                case OVRCustomFace.RetargetingType.ARKitBlendshapes:
                    generatedMapping = ARKitAutoGeneratedMapping(renderer.sharedMesh,
                        customFace._allowDuplicateMapping);
                    break;
#endif
                default:
...
#if OVR_INTERNAL_CODE
    internal static OVRFaceExpressions.FaceExpression[] ARKitAutoGeneratedMapping(Mesh sharedMesh,
        bool allowDuplicateMapping)
    {
        ...
        return AutoGenerateMapping(sharedMesh,
            arKitBlendShapeNames, arKitFaceExpressions, allowDuplicateMapping);
    }
#endif
}
