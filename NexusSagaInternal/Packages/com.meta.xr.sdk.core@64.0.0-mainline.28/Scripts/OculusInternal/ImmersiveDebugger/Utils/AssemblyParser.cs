...
namespace Meta.XR.ImmersiveDebugger.Utils
{
    internal static class AssemblyParser
    {
        ...
        public static void Mock(Assembly assembly)
        {
            _enabledDelegate = () => true;
            _assembliesDelegate = () => new Assembly[] { assembly };
        }

        public static void Unmock()
        {
            _enabledDelegate = GetImmersiveDebuggerEnabled;
            _assembliesDelegate = GetAllAssemblies;
        }
#endif
#endif
