...
namespace Meta.XR.ImmersiveDebugger.Manager
{
    ...
    {
        internal readonly Dictionary<Type, List<MethodInfo>> ActionsDict = new Dictionary<Type, List<MethodInfo>>();
        ...
        public void ProcessType(Type type)
        {
            ...
            ManagerUtils.RebuildInspectorForType(_uiPanel, _instanceCache, type, actionList, (memberController, member, instance) =>
            {
                memberController.RegisterAction(() => member.Invoke(instance, null));
            });
        }
