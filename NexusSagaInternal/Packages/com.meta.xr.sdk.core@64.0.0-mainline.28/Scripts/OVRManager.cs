...
#if OVR_INTERNAL_CODE
    /// <summary>
    /// Occurs when a plane tracker create request result received
    /// @params (UInt64 request, bool result)
    /// </summary>
    public static event Action<UInt64, bool> CreatePlaneTrackerResults;

    /// <summary>
    /// Occurs when a plane tracker destroy request result received
    /// @params (UInt64 request, bool result)
    /// </summary>
    public static event Action<UInt64, bool> DestroyPlaneTrackerResults;
#endif

#if OVR_INTERNAL_CODE
    /// <summary>
    /// Occurs when a scene object tracker create request result received
    /// @params (UInt64 requestId, bool result)
    /// </summary>
    public static event Action<UInt64, bool> CreateSceneObjectTrackerResults;

    /// <summary>
    /// Occurs when a scene object tracker destroy request result received
    /// @params (UInt64 requestId, bool result)
    /// </summary>
    public static event Action<UInt64, bool> DestroySceneObjectTrackerResults;
#endif

#if OVR_INTERNAL_CODE
    /// <summary>
    /// Occurs when a scene reconstruction tracker create request result received
    /// @params (UInt64 requestId, bool result)
    /// </summary>
    public static event Action<UInt64, bool> CreateSceneReconstructionTrackerResults;

    /// <summary>
    /// Occurs when a scene reconstruction tracker destroy request result received
    /// @params (UInt64 requestId, bool result)
    /// </summary>
    public static event Action<UInt64, bool> DestroySceneReconstructionTrackerResults;

    /// <summary>
    /// Occurs when a scene reconstruction tracker settings update request result received
    /// @params (UInt64 requestId, bool result)
    /// </summary>
    public static event Action<UInt64, bool> UpdateSceneReconstructionTrackerSettingsResults;

        /// <summary>
    /// Occurs when a scene reconstruction tracker roombox update request result received
    /// @params (UInt64 requestId, bool result)
    /// </summary>
    public static event Action<UInt64, bool> UpdateSceneReconstructionTrackerRoomboxResults;
#endif

#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
    /// <summary>
    /// Occurs when a local group start request result received
    /// @params (UInt64 request, UInt64 creatorParticipantId, int result, Guid uuid)
    /// </summary>
    public static event Action<UInt64, UInt64, int, Guid> LocalGroupStartComplete;

    /// <summary>
    /// Occurs when the local group discovery process ends
    /// @params (UInt64 request, bool result, LocalGroupDiscoveryStopReason reason)
    /// </summary>
    public static event Action<UInt64, bool, OVRPlugin.LocalGroupDiscoveryStopReason> LocalGroupDiscoveryComplete;

    ///TODO:fix
    /// <summary>
    /// Occurs when a new local group discovered
    /// @params (UInt64 request, Guid groupUuid, string groupAppInfo)
    /// </summary>
    public static event Action<UInt64, Guid, string> LocalGroupDiscoveredResult;

    /// <summary>
    /// Occurs when the local group join request completes
    /// @params (UInt64 request, UInt64 joinerParticipantId, int result, string appInfo)
    /// </summary>
    public static event Action<UInt64, UInt64, int, string> LocalGroupJoinComplete;

    /// <summary>
    /// Occurs when the local group leave request completes
    /// @params (UInt64 request, int result)
    /// </summary>
    public static event Action<UInt64, int> LocalGroupLeaveComplete;

    /// <summary>
    /// Occurs when a new local group participant joins
    /// @params (Guid groupUuid, UInt64 participantId, string participantAppInfo)
    /// </summary>
    public static event Action<Guid, UInt64, string> LocalGroupParticipantJoined;

    /// <summary>
    /// Occurs when a local group participant leaves
    /// @params (Guid groupUuid, UInt64 participantId)
    /// </summary>
    public static event Action<Guid, UInt64> LocalGroupParticipantLeft;

    /// <summary>
    /// Occurs when the local group set discoverability mode request completes
    /// @params (UInt64 request, bool result)
    /// </summary>
    public static event Action<UInt64, bool> LocalGroupSetDiscoverabilityModeComplete;

    /// <summary>
    /// Occurs when the local group set app info request completes
    /// @params (UInt64 request, int result)
    /// </summary>
    public static event Action<UInt64, int> LocalGroupSetAppInfoComplete;

    /// <summary>
    /// Occurs when the local group current participant set app info request completes
    /// @params (UInt64 request, int result)
    /// </summary>
    public static event Action<UInt64, int> LocalGroupParticipantSetAppInfoComplete;

    /// <summary>
    /// Occurs when the local group discoverability mode updated
    /// @params (Guid groupUuid, OVRPlugin.LocalGroupDiscoverabilityMode mode)
    /// </summary>
    public static event Action<Guid, OVRPlugin.LocalGroupDiscoverabilityMode> LocalGroupDiscoverabilityModeUpdated;

    /// <summary>
    /// Occurs when the local group app info updated
    /// @params (Guid groupUuid, string appInfo)
    /// </summary>
    public static event Action<Guid, string> LocalGroupAppInfoUpdated;

    /// <summary>
    /// Occurs when other local group participant app info updated
    /// @params (Guid groupUuid, UInt64 participantId, string appInfo)
    /// </summary>
    public static event Action<Guid, UInt64, string> LocalGroupParticipantAppInfoUpdated;

    /// <summary>
    /// Occurs when the local group participants query results are ready
    /// @params (UInt64 request, bool result, UInt32 participantsCount)
    /// </summary>
    public static event Action<UInt64, bool, UInt32> LocalGroupParticipantsQueryResultsReady;

    /// <summary>
    /// Occurs when the share space to local group request completes
    /// </summary>
    /// <remarks>
    /// @params (ulong requestId, OVRPlugin.LocalGroupShareSpacesResult result)
    /// </remarks>
    public static event Action<ulong, OVRPlugin.LocalGroupShareSpacesResult> LocalGroupShareSpacesComplete;

    /// <summary>
    /// Occurs when a local group participant has shared a space with the local group
    /// </summary>
    /// <remarks>
    /// @params (Guid groupUuid, UInt32 spaceCount, Guid[] spaceUuids)
    /// </remarks>
    public static event Action<Guid, UInt32, Guid[]> LocalGroupSpacesShared;
#endif
...
#endif // OVR_INTERNAL_CODE // XR_META_boundary_visibility

#if OVR_INTERNAL_CODE // TODO - remove redaction before public release (T175611441)
    /// <summary>
    /// Occurs when the dynamic object tracker create operation completes
    /// </summary>
    /// <remarks>
    /// @params (OVRPlugin.Result result)
    /// </remarks>
    public static event Action<OVRPlugin.Result> CreateDynamicObjectTrackerComplete;

    /// <summary>
    /// Occurs when the set dynamic object tracked classes operation completes
    /// </summary>
    /// <remarks>
    /// @params (OVRPlugin.Result result)
    /// </remarks>
    public static event Action<OVRPlugin.Result> SetDynamicObjectTrackedClassesComplete;
#endif // OVR_INTERNAL_CODE
...
#pragma warning restore
    ...
    {
        if (handSkeletonVersion == OVRHandSkeletonVersion.Uninitialized)

        {
            // Default to V1. Eventually we will update this to default to V2.
            handSkeletonVersion = OVRHandSkeletonVersion.V1;
        }
    }
#endif
...
#pragma warning restore CS0618
    ...
    /// </summary>
    [HideInInspector] public bool isBoundaryVisibilitySuppressed { get; private set; } = false;
...
#if OVR_INTERNAL_CODE
    /// <summary>
    /// Which hand skeleton format to use. Defaults to V1 for compatability reasons, but newer projects should use V2.
    /// </summary>
    public static OVRHandSkeletonVersion _handSkeletonVersion { get; private set; }

    /// <summary>
    /// This field exists to populate the OVRManager inspector so that users can control it.
    /// Copied to _handSkeletonVersion for broader access.
    /// </summary>
    [Tooltip("Which version of the hand skeleton to use. New projects should use the V2 format.")]
    public OVRHandSkeletonVersion handSkeletonVersion;
#endif // OVR_INTERNAL_CODE

#if OVR_INTERNAL_CODE
    [HideInInspector, Tooltip("Specify if on-headset Immersive Debugger is enabled.")]
    public bool isImmersiveDebuggerEnabled = false;
#endif
    ...
    [System.Obsolete("Deprecated. Please use handTrackingFeatureFidelityGroup.targetFeatureEnabled", true),
     HideInInspector]
    public FeatureEnableState handTrackingFeatureEnabled = FeatureEnableState.Off;

    [System.Obsolete("Deprecated. Please use handTrackingFeatureFidelityGroup.targetFeatureFidelity", true),
     HideInInspector]
    public FeatureFidelity handTrackingFeatureFidelity = FeatureFidelity.Low;

    [System.Obsolete("Deprecated. Please use handTrackingFeatureFidelityGroup.currentFeatureEnabled", true),
     HideInInspector]
    public FeatureEnableState currentHandTrackingFeatureEnabled { get; private set; }

    [System.Obsolete("Deprecated. Please use handTrackingFeatureFidelityGroup.currentFeatureFidelity", true),
     HideInInspector]
    ...
    {
        get { return OVRPlugin.temporalFoveatedRenderingSupported; }
    }
    ...
    {
        get { return OVRPlugin.temporalFoveatedRenderingEnabled; }
        set { OVRPlugin.temporalFoveatedRenderingEnabled = value; }
    }
#endif
...
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE  // Hands3.0  To be removed after WideMotionModeShips
    [SerializeField]
    [HideInInspector]
    private bool _readOnlyBodyFusionHandPosesEnabled = false;
    [Tooltip("Defines if hand poses can leverage Body API data to inform pose positions.")]
    public bool bodyFusionHandPosesEnabled = false;
#endif
    ...
    {
#if OVR_INTERNAL_CODE
        _handSkeletonVersion = OVRHandSkeletonVersion.Uninitialized;
#endif
    ...
    private void Update()
    {
...
#if OVR_INTERNAL_CODE
        if (_handSkeletonVersion != handSkeletonVersion)

        {
            UpdateHandSkeletonVersion();
        }
#endif
        ...
        if (_readOnlyBodyFusionHandPosesEnabled != bodyFusionHandPosesEnabled)
        {
            _readOnlyBodyFusionHandPosesEnabled = bodyFusionHandPosesEnabled;
            OVRPlugin.SetBodyFusionHandPoses(_readOnlyBodyFusionHandPosesEnabled);
        }
#endif
...
#if OVR_INTERNAL_CODE
        if (featureFidelitySystemActivated)
        {
            UpdateFeatureFidelity();
        }
#endif // OVR_INTERNAL_CODE
    }

#if OVR_INTERNAL_CODE
    private void UpdateHandSkeletonVersion()
    {
        _handSkeletonVersion = handSkeletonVersion;
        OVRPlugin.SetHandSkeletonVersion(_handSkeletonVersion);
    }
#endif
    ...
    private void UpdateHMDEvents()
    {
        while (OVRPlugin.PollEvent(ref eventDataBuffer))
        {
            switch (eventDataBuffer.EventType)
            {
                ...
                break;
#if OVR_INTERNAL_CODE
                case OVRPlugin.EventType.CreatePlaneTrackerResults:
                    if (CreatePlaneTrackerResults != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.CreatePlaneTrackerResultsData>(
                                eventDataBuffer
                                    .EventData);
                        CreatePlaneTrackerResults(data.Request, data.Result >= 0);
                    }

                    break;
                case OVRPlugin.EventType.DestroyPlaneTrackerResults:
                    if (DestroyPlaneTrackerResults != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.DestroyPlaneTrackerResultsData>(
                                eventDataBuffer.EventData);
                        DestroyPlaneTrackerResults(data.Request, data.Result >= 0);
                    }

                    break;
#endif // OVR_INTERNAL_CODE
#if OVR_INTERNAL_CODE
                case OVRPlugin.EventType.CreateSceneObjectTrackerResults:
                    if (CreateSceneObjectTrackerResults != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.CreateSceneObjectTrackerResultsData>(
                                eventDataBuffer.EventData);
                        CreateSceneObjectTrackerResults(data.RequestId, data.Result >= 0);
                    }

                    break;
                case OVRPlugin.EventType.DestroySceneObjectTrackerResults:
                    if (DestroySceneObjectTrackerResults != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.DestroySceneObjectTrackerResultsData>(
                                eventDataBuffer.EventData);
                        DestroySceneObjectTrackerResults(data.RequestId, data.Result >= 0);
                    }

                    break;
#endif // OVR_INTERNAL_CODE
#if OVR_INTERNAL_CODE
                case OVRPlugin.EventType.CreateSceneReconstructionTrackerResults:
                    if (CreateSceneReconstructionTrackerResults != null)
                    {
                        var data = OVRDeserialize
                            .ByteArrayToStructure<OVRDeserialize.CreateSceneReconstructionTrackerResultsData>(
                                eventDataBuffer.EventData);
                        CreateSceneReconstructionTrackerResults(data.RequestId, data.Result >= 0);
                    }

                    break;
                case OVRPlugin.EventType.DestroySceneReconstructionTrackerResults:
                    if (DestroySceneReconstructionTrackerResults != null)
                    {
                        var data = OVRDeserialize
                            .ByteArrayToStructure<OVRDeserialize.DestroySceneReconstructionTrackerResultsData>(
                                eventDataBuffer.EventData);
                        DestroySceneReconstructionTrackerResults(data.RequestId, data.Result >= 0);
                    }

                    break;
                case OVRPlugin.EventType.UpdateSceneReconstructionTrackerSettingsResults:
                    if (UpdateSceneReconstructionTrackerSettingsResults != null)
                    {
                        var data = OVRDeserialize
                            .ByteArrayToStructure<OVRDeserialize.UpdateSceneReconstructionTrackerSettingsResultsData>(
                                eventDataBuffer.EventData);
                        UpdateSceneReconstructionTrackerSettingsResults(data.RequestId, data.Result >= 0);
                    }

                    break;
                case OVRPlugin.EventType.UpdateSceneReconstructionTrackerRoomboxResults:
                    if (UpdateSceneReconstructionTrackerRoomboxResults != null)
                    {
                        var data = OVRDeserialize
                            .ByteArrayToStructure<OVRDeserialize.UpdateSceneReconstructionTrackerRoomboxResultsData>(
                                eventDataBuffer.EventData);
                        UpdateSceneReconstructionTrackerRoomboxResults(data.RequestId, data.Result >= 0);
                    }

                    break;
#endif // OVR_INTERNAL_CODE
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
                case OVRPlugin.EventType.LocalGroupStartComplete:
                    if (LocalGroupStartComplete != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupStartCompleteData>(
                                eventDataBuffer.EventData);
                        LocalGroupStartComplete(data.CreateRequestId, data.CreatorParticipantId, data.Result, data.GroupUuid);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupDiscoveryComplete:
                    if (LocalGroupDiscoveryComplete != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupDiscoveryCompleteData>(
                                eventDataBuffer.EventData);
                        LocalGroupDiscoveryComplete(data.DiscoveryRequestId, data.Result >= 0, data.Reason);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupDiscoveredResult:
                    if (LocalGroupDiscoveredResult != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupDiscoveredResultData>(
                                eventDataBuffer.EventData);
                        LocalGroupDiscoveredResult(data.DiscoveryRequestId, data.GroupUuid, data.GroupAppInfo);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupJoinComplete:
                    if (LocalGroupJoinComplete != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupJoinCompleteData>(
                                eventDataBuffer.EventData);
                        LocalGroupJoinComplete(data.JoinRequestId, data.JoinerParticipantId, data.Result,
                            data.GroupAppInfo);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupLeaveComplete:
                    if (LocalGroupLeaveComplete != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupLeaveCompleteData>(
                                eventDataBuffer.EventData);
                        LocalGroupLeaveComplete(data.LeaveRequestId, data.Result);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupParticipantJoined:
                    if (LocalGroupParticipantJoined != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupParticipantJoinedData>(
                                eventDataBuffer.EventData);
                        LocalGroupParticipantJoined(data.GroupUuid, data.ParticipantId, data.ParticipantAppInfo);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupParticipantLeft:
                    if (LocalGroupParticipantLeft != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupParticipantLeftData>(
                                eventDataBuffer.EventData);
                        LocalGroupParticipantLeft(data.GroupUuid, data.ParticipantId);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupSetDiscoverabilityModeComplete:
                    if (LocalGroupSetDiscoverabilityModeComplete != null)
                    {
                        var data =
                            OVRDeserialize
                                .ByteArrayToStructure<OVRDeserialize.LocalGroupSetDiscoverabilityModeCompleteData>(
                                    eventDataBuffer.EventData);
                        LocalGroupSetDiscoverabilityModeComplete(data.SetDiscoverabilityModeRequestId,
                            data.Result >= 0);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupSetAppInfoComplete:
                    if (LocalGroupSetAppInfoComplete != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupSetAppInfoCompleteData>(
                                eventDataBuffer.EventData);
                        LocalGroupSetAppInfoComplete(data.SetAppInfoRequestId, data.Result);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupParticipantSetAppInfoComplete:
                    if (LocalGroupParticipantSetAppInfoComplete != null)
                    {
                        var data =
                            OVRDeserialize
                                .ByteArrayToStructure<OVRDeserialize.LocalGroupParticipantSetAppInfoCompleteData>(
                                    eventDataBuffer.EventData);
                        LocalGroupParticipantSetAppInfoComplete(data.SetParticipantAppInfoRequestId, data.Result);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupDiscoverabilityModeUpdated:
                    if (LocalGroupDiscoverabilityModeUpdated != null)
                    {
                        var data =
                            OVRDeserialize
                                .ByteArrayToStructure<OVRDeserialize.LocalGroupDiscoverabilityModeUpdatedData>(
                                    eventDataBuffer.EventData);
                        LocalGroupDiscoverabilityModeUpdated(data.GroupUuid, data.DiscoverabilityMode);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupAppInfoUpdated:
                    if (LocalGroupAppInfoUpdated != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupAppInfoUpdatedData>(
                                eventDataBuffer.EventData);
                        LocalGroupAppInfoUpdated(data.GroupUuid, data.GroupAppInfo);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupParticipantAppInfoUpdated:
                    if (LocalGroupAppInfoUpdated != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupParticipantAppInfoUpdatedData>(
                                eventDataBuffer.EventData);
                        LocalGroupParticipantAppInfoUpdated(data.GroupUuid, data.ParticipantId,
                            data.ParticipantAppInfo);
                    }

                    break;
                case OVRPlugin.EventType.LocalGroupParticipantsQueryResultsReady:
                    if (LocalGroupParticipantsQueryResultsReady != null)
                    {
                        var data =
                            OVRDeserialize
                                .ByteArrayToStructure<OVRDeserialize.LocalGroupParticipantsQueryResultsReadyData>(
                                    eventDataBuffer.EventData);
                        LocalGroupParticipantsQueryResultsReady(data.QueryRequestId, data.Result >= 0,
...
#endif // OVR_PARTNER_CODE || OVR_INTERNAL_CODE
#if OVR_PARTNER_CODE || OVR_INTERNAL_CODE
                case OVRPlugin.EventType.LocalGroupShareSpacesComplete:
                    if (LocalGroupShareSpacesComplete != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupShareSpacesCompleteData>(
                                eventDataBuffer.EventData);
                        LocalGroupShareSpacesComplete(data.RequestId, data.Result);
                    }

                    break;

                case OVRPlugin.EventType.LocalGroupSpacesShared:
                    if (LocalGroupSpacesShared != null)
                    {
                        var data =
                            OVRDeserialize.ByteArrayToStructure<OVRDeserialize.LocalGroupSpacesSharedData>(
                                eventDataBuffer.EventData);
                        LocalGroupSpacesShared(data.GroupUuid, data.SpaceCount, data.SpaceUuids);
                    }
                ...
                case OVRPlugin.EventType.ReturnToRoomUserLocationChanged:
                {
                    var data = OVRDeserialize.ByteArrayToStructure<OVRDeserialize.ReturnToRoomUserLocationChanged>(
                        eventDataBuffer.EventData);

                    OVRAnchor.OnUserLocationChanged(data.RoomUuid, data.UserLocation);
                    break;
                }
#endif
#if OVR_INTERNAL_CODE // TODO - remove redaction before public release (T175611441)
                case OVRPlugin.EventType.CreateDynamicObjectTrackerResults:
                {
                    var data = OVRDeserialize.ByteArrayToStructure<OVRDeserialize.CreateDynamicObjectTrackerResultsData>(eventDataBuffer.EventData);
                    CreateDynamicObjectTrackerComplete?.Invoke(data.Result);
                    break;
                }
                case OVRPlugin.EventType.SetDynamicObjectTrackedClassesResults:
                {
                    var data = OVRDeserialize.ByteArrayToStructure<OVRDeserialize.SetDynamicObjectTrackedClassesResultsData>(eventDataBuffer.EventData);
                    SetDynamicObjectTrackedClassesComplete?.Invoke(data.Result);
                    break;
                }
#endif
                default:
...
#if OVR_INTERNAL_CODE
    private HashSet<OVRPlugin.FeatureType> featureFidelityGetFeatureStateErrorDumped =
        new HashSet<OVRPlugin.FeatureType>();
    ...
    void UpdateFeatureFidelityGroup(OVRPlugin.FeatureType type, FeatureFidelityGroup group)
    {
        ...
        if (OVRPlugin.FeatureFidelityGetFeatureState(type, out idealFeatureState, out currentFeatureState))
        {
            ...
            if (!group.lastSetTargetFeatureEnabled.HasValue ||
                group.lastSetTargetFeatureEnabled != group.targetFeatureEnabled)
            {
                ...
                {
                    if (OVRPlugin.FeatureFidelitySetFeatureEnable(type,
                            (OVRPlugin.FeatureEnableState)group.targetFeatureEnabled))
                    {
                        Debug.Log($"[UpdateFeatureFidelity] Set {type} FeatureEnableState from " +
                                  $"{idealFeatureState.enableState} to {group.targetFeatureEnabled}");
                    }
                    else
                    {
                        Debug.LogWarning($"[UpdateFeatureFidelity] Failed to set {type} " +
                                         $"FeatureEnableState: current {idealFeatureState.enableState}, target {group.targetFeatureEnabled}");
                    }
                }
            ...
            if (!group.lastSetTargetFeatureFidelity.HasValue ||
                group.lastSetTargetFeatureFidelity != group.targetFeatureFidelity)
            {
                ...
                {
                    if (OVRPlugin.FeatureFidelitySetFeatureFidelity(type,
                            (OVRPlugin.FeatureFidelity)group.targetFeatureFidelity))
                    {
                        Debug.Log($"[UpdateFeatureFidelity] Set {type} FeatureFidelity from " +
                                  $"{idealFeatureState.fidelity} to {group.targetFeatureFidelity}");
                    }
                    else
                    {
                        Debug.LogWarning($"[UpdateFeatureFidelity] Failed to set {type} " +
                                         $"FeatureFidelity: current {idealFeatureState.fidelity}, target {group.targetFeatureFidelity}");
                    }
                }
    ...
    void UpdateFeatureFidelity()
    {
        ...
        UpdateFeatureFidelityGroup(OVRPlugin.FeatureType.GazeBasedFoveatedRendering,
