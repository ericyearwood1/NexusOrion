...
{
    public class ScrollInertiaBoundless : MonoBehaviour
    {
        [SerializeField, ReadOnly] private ScrollControllerBoundless _controller;
        ...
        protected void Start()
        {
            ...
            _inertia.Boundaries = Inertia.Boundless.Instance;
