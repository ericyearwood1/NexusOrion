...
{
    [CustomEditor(typeof(ListItemStyleEnforcer))]
    public class ListItemStyleSwitcherEditor : Editor
    {
        private void OnEnable()
        {
            //both needed for stopping when entering and exiting playmode
        ...
        {
            ListItemStyleEnforcer styleEnforcer = (ListItemStyleEnforcer)target;
